...
//         <p className={`text-xs mt-0.5 ${isDark ? 'text-slate-400' : 'text-slate-400'}`}>{tier === "premium" ? "Premium Â· â‚¹2,999/mo" : "Basic Â· â‚¹1,999/mo"}</p>
//       </div>
...
//             {review.rating != null && (
//               <span className={`text-xs font-bold px-2 py-0.5 rounded-full ${ratingColor}`}>â˜… {review.rating}</span>
//             )}
//             {review.has_response && (
...
//               <p className={`text-xs ${isDark ? 'text-blue-300' : 'text-blue-600'}`}>Generating AI replyâ€¦</p>
//             </div>
//           ) : (
...
//               <p className={`font-medium ${isDark ? 'text-slate-400' : 'text-slate-500'}`}>Analysing reviews & finding similar competitorsâ€¦</p>
...
//                       <p className="text-3xl font-black text-amber-500">{data.star_rating?.toFixed(1) || "â€”"}</p>
//                       <Star className="w-6 h-6 text-amber-400 fill-amber-400" />
//                     </div>
//                     <p className={`text-xs mt-0.5 ${isDark ? 'text-slate-500' : 'text-slate-400'}`}>{data.total_ratings?.toLocaleString() || "â€”"} ratings</p>
//                     {data.seller_rating && <p className={`text-xs mt-0.5 ${isDark ? 'text-slate-400' : 'text-slate-500'}`}>Seller: â˜… {data.seller_rating}</p>}
//                   </div>
//                 </div>
//               </div>
// 
...
//                       <p className="text-5xl font-black text-amber-500">{data.star_rating?.toFixed(1) || "â€”"}</p>
...
//                       <InfoTip text="What percentage of customer reviews you (the seller) have replied to. Amazon rewards sellers who respond quickly â€” it improves your account health score." isDark={isDark} />
//                     </h3>
//                     <div className="flex items-end gap-3">
//                       <p className={`text-4xl font-black ${isDark ? 'text-sky-400' : 'text-sky-600'}`}>{data.response_rate_pct != null ? `${data.response_rate_pct}%` : "â€”"}</p>
...
//                       {(data.response_rate_pct || 0) > 50 ? "âœ“ Strong response rate â€” builds buyer trust" : "â†‘ Respond to more reviews to improve seller score"}
//                     </p>
//                   </div>
//                 </div>
//                 {/* Portfolio rating */}
...
//                     </h3>
//                     <div className="flex items-end gap-3">
//                       <p className="text-4xl font-black text-amber-500">{data.avg_seller_portfolio_rating?.toFixed(2) || "â€”"}</p>
//                       <Star className="w-6 h-6 text-amber-400 fill-amber-400 mb-1" />
//                     </div>
//                     <p className={`text-xs mt-2 ${isDark ? 'text-slate-400' : 'text-slate-500'}`}>Average across {data.seller_product_count || "â€”"} tracked products</p>
...
//                           {data.star_rating >= data.avg_seller_portfolio_rating ? "â†‘ Above avg" : "â†“ Below avg"}
//                         </span>
//                       </div>
//                     )}
//                   </div>
...
//                     <SentimentBar label="Positive (4â€“5 â˜…)" pct={data.sentiment_breakdown?.positive ?? 80} icon={ThumbsUp} color="#10b981" isDark={isDark} />
//                     <SentimentBar label="Neutral (3 â˜…)" pct={data.sentiment_breakdown?.neutral ?? 12} icon={Minus} color="#f59e0b" isDark={isDark} />
//                     <SentimentBar label="Negative (1â€“2 â˜…)" pct={data.sentiment_breakdown?.negative ?? 8} icon={ThumbsDown} color="#ef4444" isDark={isDark} />
//                   </div>
//                 </div>
//               </div>
// 
...
//                         <p className={`text-[10px] font-mono ${isDark ? 'text-slate-400' : 'text-slate-400'}`}>{data.asin} Â· YOU</p>
//                       </div>
...
//                       </div>
//                       <div>
//                         <p className={`font-bold text-sm mb-1 ${isDark ? 'text-slate-200' : 'text-slate-800'}`}>AI Draft Replies â€” Per Review</p>
...
//                       {!isBasic
//                         ? "See recent reviews, response rates and seller insights â€” Basic Â· â‚¹1,999/mo"
//                         : "Get sentiment analysis, smart competitor matching & AI response suggestions â€” Premium Â· â‚¹2,999/mo"}
//                     </p>
