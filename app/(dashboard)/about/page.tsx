  ...
  return (
    <div className="space-y-8 py-6">
      ...
      <div className="text-center space-y-4">
        <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-[#00C6FF]/20 to-[#0072FF]/20 rounded-2xl mb-2 shadow-sm mx-auto border border-white/40">
          <Brain className="h-10 w-10 text-[#0072FF]" />
        </div>
        <h1 className="text-3xl font-bold text-[#003366]">About Insydz</h1>
      ...
      {/* Mission */}
      <Card className="bg-gradient-to-r from-[#00C6FF]/10 to-[#0072FF]/10 border border-[#00C6FF]/20 rounded-2xl">
        <CardContent className="p-6 text-center">
          <h2 className="text-xl font-bold mb-3 text-[#003366]">Our Mission</h2>
      ...
      {/* Features */}
      <div>
        <h2 className="text-xl font-bold text-[#003366] mb-5">What We Offer</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {FEATURES.map((feature, index) => (
            <Card key={index} className="h-full shadow-sm border border-slate-200 rounded-2xl bg-white/70 hover:shadow-md transition-shadow">
              <CardHeader className="pb-2">
                <div className="w-10 h-10 bg-slate-50 rounded-xl flex items-center justify-center mb-3">
                  {feature.icon}
                </div>
                <CardTitle className="text-base font-semibold text-[#003366]">{feature.title}</CardTitle>
              </CardHeader>
              <CardContent>
      ...
      {/* Stats */}
      <div>
        <h2 className="text-xl font-bold text-[#003366] mb-5">Our Impact</h2>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {STATS.map((stat, index) => (
            <Card key={index} className="text-center p-4 shadow-sm border border-slate-200 rounded-2xl bg-white/70">
              <div className="flex justify-center mb-2">
                <div className="w-9 h-9 bg-[#00C6FF]/10 rounded-lg flex items-center justify-center text-[#0072FF]">
                  {stat.icon}
                </div>
              </div>
              <div className="text-lg font-bold text-[#0072FF] mb-0.5">{stat.value}</div>
      ...
      {/* Values */}
      <div>
        <h2 className="text-xl font-bold text-[#003366] mb-5">Our Values</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {TEAM_VALUES.map((value, index) => (
            <Card key={index} className="text-center p-5 shadow-sm border border-slate-200 rounded-2xl bg-white/70 hover:shadow-md transition-shadow">
              <div className="flex justify-center mb-3">{value.icon}</div>
              <h3 className="text-base font-semibold text-[#003366] mb-2">{value.title}</h3>
      ...
      {/* Contact */}
      <Card className="bg-slate-50/80 shadow-sm border border-slate-200 rounded-2xl">
        <CardContent className="p-6 text-center">
          <h2 className="text-lg font-semibold text-[#003366] mb-3">Get in Touch</h2>
          ...
          <div className="flex flex-wrap justify-center gap-x-8 gap-y-2 text-sm">
            <p>
              ...
              <a href="mailto:contact@insydz.com" className="text-blue-600 hover:underline">
                contact@insydz.com
              </a>
            </p>
            <p>
              <strong className="text-slate-700">Support: </strong>
              <a href="mailto:support@insydz.com" className="text-blue-600 hover:underline">
                support@insydz.com
              </a>
            </p>
            <p>
