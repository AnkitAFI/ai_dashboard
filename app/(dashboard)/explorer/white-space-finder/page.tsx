    ...
    >
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center gap-2 bg-background/95 dark:bg-background/95 backdrop-blur-none">
        ...
        <p className="text-xs text-slate-550 dark:text-slate-400">
          Unlock Full Access to unlock all results
        </p>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-slate-500 text-sm font-medium">
                Discover untapped product gaps and find whitespace opportunities
          ...
          <div className="flex items-center gap-3 flex-wrap">
            ...
            {result && (
              <div className="bg-background opacity-100 rounded-xl px-4 py-2 border border-slate-200 shadow-sm min-w-[160px]">
                <div className="flex items-center justify-between gap-3 mb-1">
                  ...
                  <Badge
                    className={`h-4 text-[10px] border-none px-1.5 ${tier === "premium" ? "bg-violet-100 text-violet-800" : tier === "basic" ? "bg-amber-100 text-amber-800" : "bg-slate-100 text-slate-600"}`}
                  >
                    {tier.toUpperCase()}
                  </Badge>
                </div>
                <div className="flex items-center gap-2">
                  <div className="flex-1 bg-slate-100 rounded-full h-1.5 overflow-hidden">
                    <div
                      ...
                      style={{
                        width: `${scanPct}%`,
                        background: scanPct >= 80 ? "#ef4444" : "#7F77DD",
                      }}
                    />
                  </div>
            ...
            {!result &&
              (authLoading ? (
                ...
                <Badge
                  className={`text-[10px] border-none px-2 py-1 ${
                    tier === "premium"
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-400 dark:text-slate-500">
                        ...
                        {(ollamaStatus.status === "offline" ||
                          ollamaStatus.status === "no_model") &&
                          ollamaStatus.setup_hint && (
                            <code className="ml-1 bg-slate-100 dark:bg-slate-800 px-1 rounded text-slate-600 dark:text-slate-350">
                              {ollamaStatus.setup_hint}
                            </code>
                          )}
                      </p>
          ...
          {!result && !loading && (
            <div className="flex flex-col items-center justify-center py-20 text-center">
              ...
              <p className="text-sm text-slate-400 dark:text-slate-500 max-w-md leading-relaxed mb-6">
                Scan any keyword to surface real white spaces — niches with high
