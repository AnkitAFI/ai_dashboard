...
export default function AiAdvisor() {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-100px)]">
      {/* Header Info */}
      <div className="flex-none flex flex-col md:flex-row items-start md:items-center justify-between gap-3 mb-3 pb-3 border-b border-sky-100/80 dark:border-slate-800">
        <div className="flex items-center gap-3 min-w-0">
          <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-blue-100 to-cyan-100 dark:from-blue-950 dark:to-cyan-950 rounded-2xl flex items-center justify-center shadow-inner shrink-0">
            <Sparkles className="h-5 w-5 sm:h-6 sm:w-6 text-amber-500 animate-pulse" />
          </div>
          <div className="min-w-0 flex-1">
            <h1 className="text-xl sm:text-3xl font-bold bg-gradient-to-r from-blue-500 via-cyan-400 to-emerald-400 text-transparent bg-clip-text truncate">
        ...
        <div className="hidden sm:flex items-center gap-2 px-3 py-1.5 bg-sky-50 dark:bg-sky-950/20 border border-sky-100 dark:border-slate-800 rounded-full shrink-0">
          ...
          <span className="text-xs font-semibold text-sky-800 dark:text-sky-400 uppercase tracking-wider">
            {t("aiAdvisor.aiAssistant", "AI Powered Assistant")}
          </span>
        </div>
      </div>
