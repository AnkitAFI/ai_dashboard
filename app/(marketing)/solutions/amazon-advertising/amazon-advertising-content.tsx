...
const coreFeatures = [
  {
    ...
    title: "Find Winning Keywords Without Spreadsheets",
    desc: "Stop wasting hours copying and pasting from Amazon ad reports. Insydz spots the exact search terms shoppers use to buy your product and recommends adding them to your campaigns, while highlighting words that waste your money.",
    bullets: [
      "Spots profitable search terms that generate orders below your Target ACOS",
      "Flags zero-sale search terms that eat your budget without conversions",
      "Helps prevent your auto and manual ad campaigns from competing against each other",
      "Clear tracking for every product and keyword in your catalogue",
    ],
  ...
  },
  {
    ...
    bullets: [
      ...
      "Recommends higher bids on top-selling keywords to help you win more orders",
      "Recommends lowering bids on underperforming keywords so you stop bleeding money",
      "Simple English explanations showing exactly why a recommendation was made",
    ],
  ...
  },
  {
    ...
    title: "1-Click Recommendations Checklist",
    desc: "Stay in 100% control of your advertising budget. Review daily bid and keyword suggestions in a simple checklist. Nothing is ever changed automatically—you decide which recommendations to approve or reject.",
    bullets: [
      "100% Seller Control: Nothing changes until you review and click Approve",
      "Review, approve, or reject recommendations in 1-click",
      "Safety Ceilings: Set maximum bid limits so you never overpay for a click",
      "Zero Hallucinations: Based on strict Target-ACOS profit math, never blind AI",
    ],
  ...
  },
  {
    ...
    title: "Real Bottom-Line Profitability (TACoS)",
    desc: "Look beyond simple ad reports. We combine your ad spend with your total organic sales so you always know your actual Total ACOS (TACoS) and take-home profit across Amazon India.",
    bullets: [
      "Tracks Total ACOS (TACoS) combining organic sales and ad sales",
      "Built specifically for Indian sellers with INR currency and local categories",
      "Drill down into profit by campaign, ad group, keyword, and ASIN",
      "Clear alerts when ad spend rises faster than your overall revenue",
    ],
...
const comparisonRows = [
  {
    ...
    insydz: "Rule-based math based on your profit goals",
    others: "Blind guessing or arbitrary percentage rules",
  },
  {
    feature: "Finding Winning Keywords",
    insydz: "Smart recommendations & zero-sale bleeder blocking",
    others: "Manual spreadsheet sorting & CSV downloads",
  },
  {
    feature: "Seller Control",
    insydz: "100% in your control — approve in 1-click",
    others: "Risky black-box automation that can waste budget",
  },
  {
    feature: "Indian Market Accuracy",
    insydz: "Built natively for Amazon India in INR",
    others: "Built for US dollar budgets and foreign categories",
  },
  {
    feature: "True Profit Tracking",
    insydz: "Tracks Total ACOS (TACoS) across organic & ad sales",
    others: "Only shows isolated ad spend metrics",
  },
];

const roiLeakage = [
  { label: "Bidding too high on unprofitable keywords", value: "−₹48,000" },
  { label: "Paying for zero-sale search terms every day", value: "−₹36,000" },
...
const roiRecovery = [
  { label: "Rule-based bid recommendations protecting margin", value: "+₹45,000" },
  { label: "Blocking zero-sale search terms immediately", value: "+₹34,000" },
  { label: "Promoting winning keywords for more orders", value: "+₹28,000" },
...
const faqs: FAQItem[] = [
  {
    ...
    a: "Insydz is an Amazon seller analytics and PPC optimization platform developed by AAVAPTI TECHNOLOGIES PRIVATE LIMITED. It helps sellers find profitable keywords, reduce wasted ad spend, and manage campaign bids with simple 1-click recommendations.",
  },
  {
    id: "faq-2",
    q: "How does keyword recommendation work in simple terms?",
    a: "When shoppers search on Amazon and buy your products at a profitable cost, Insydz identifies those search terms and recommends adding them as exact match keywords in your campaigns. At the same time, it spots search terms that get clicks without sales and recommends blocking them.",
  },
  {
    id: "faq-3",
    q: "How does Insydz calculate recommended keyword bids?",
    a: "Instead of guessing, Insydz calculates recommended bids based on your Target ACOS (the maximum percentage of sales you want to spend on ads). If a keyword is too expensive, it recommends a lower bid; if a keyword is profitable, it recommends raising the bid to capture more orders.",
  },
  {
    id: "faq-4",
    q: "Does Insydz ever change my Amazon PPC bids automatically without my permission?",
    a: "Never. We believe sellers should be 100% in control of their ad spend. Insydz generates a simple daily checklist of recommended bid changes and profitable keywords. Nothing is ever pushed to your Amazon account until you review the checklist and click 'Approve'. Zero risk of AI hallucinations or unauthorized spending.",
  },
  {
    id: "faq-5",
