            ...
            <table className="w-full text-sm">
              <thead>
                <tr>
                  ...
                  <th className="text-left text-gray-400 font-medium pb-3 leading-relaxed">Jungle Scout</th>
                </tr>
              </thead>
            ...
            <table className="w-full">
              <thead>
                <tr className="bg-gradient-to-r from-blue-500 to-cyan-500">
                  ...
                  <th className="px-6 py-4 text-left text-white font-bold leading-relaxed">Jungle Scout</th>
                </tr>
              </thead>
              <tbody>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-blue-900/20 dark:to-cyan-900/20 rounded-3xl p-8 border-2 border-blue-200 dark:border-blue-800">
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
                  <span className="text-gray-700 dark:text-gray-300 leading-relaxed">Start free, upgrade only when you see results. No exchange rate surprises.</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-gray-50 dark:bg-gray-900 rounded-3xl p-8 border-2 border-gray-200 dark:border-gray-700">
              <div className="flex items-center gap-3 mb-6">
                <h3 className="text-2xl font-black text-gray-900 dark:text-white leading-relaxed">Jungle Scout Pricing (India Reality)</h3>
              </div>
              <ul className="space-y-4">
                {[
          ...
          <div className="bg-gradient-to-r from-blue-600 to-cyan-600 rounded-2xl p-8 text-white text-center">
            ...
            <p className="text-white font-black text-3xl mt-4 leading-relaxed">That's ₹33,612 per year back into inventory or ads.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-4 bg-white dark:bg-gray-950">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-gray-50 dark:bg-gray-900 rounded-3xl p-8 border-2 border-gray-200 dark:border-gray-700">
              <h3 className="text-2xl font-black text-gray-900 dark:text-white mb-6 leading-relaxed">Choose Jungle Scout if you...</h3>
              <ul className="space-y-3">
                {[
