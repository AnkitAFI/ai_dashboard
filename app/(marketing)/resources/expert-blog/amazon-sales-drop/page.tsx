  ...
  "@graph": [
    {
      ...
      "breadcrumb": {
        "@id": "https://insydz.com/blog/why-did-my-amazon-india-sales-drop-suddenly#breadcrumb"
      }
    },
    {
      "@type": "BreadcrumbList",
    ...
    {
      "@type": "BlogPosting",
      "@id": "https://insydz.com/blog/why-did-my-amazon-india-sales-drop-suddenly#article",
      "headline": "Why Did My Amazon India Sales Drop Suddenly? A Step-by-Step Diagnosis Guide",
      "description": "Orders dropped from 34 to 12 almost overnight. There is a specific, diagnosable cause and a 24hour path to finding it. Verify exact wording.",
      ...
      "mainEntityOfPage": {
        "@id": "https://insydz.com/blog/why-did-my-amazon-india-sales-drop-suddenly"
      },
      "keywords": [
        "Amazon sales drop",
    ...
    {
      "@type": "FAQPage",
      "@id": "https://insydz.com/blog/why-did-my-amazon-india-sales-drop-suddenly#faq",
      "mainEntity": [
        {
          "@type": "Question",
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify(schemaAmazonSalesDrop) }}
      />
