    ...
    <div className="min-h-screen bg-white dark:bg-gray-950 transition-colors">
        ...
        <div style={{ maxWidth: 1240, margin: "0 auto", padding: "0 16px" }} className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-7">
            <div style={{ 
              ...
              <span style={{ marginRight: 8, color: "#6366F1" }}>●</span> MARKETPLACE INTELLIGENCE · TOFU PLAYBOOK
            </div>
            ...
            <h1 style={{ fontFamily:"'Sora',sans-serif", fontSize:"clamp(28px, 4.5vw, 48px)", fontWeight:900, lineHeight:1.1, color: resolvedTheme === 'dark' ? "white" : "#111827", letterSpacing:"-1px", marginBottom:20 }}>
              How to Launch a Private Label on <span style={{ color: "#6366F1" }}>Amazon India</span> in 2026: The Complete Seller's Playbook
            </h1>
            ...
            <p style={{ fontSize: "clamp(15px, 2vw, 18px)", color: resolvedTheme === 'dark' ? "#9ca3af" : "#4B5563", lineHeight: 1.6, marginBottom: 24, maxWidth: 600, fontFamily: "'Lora', serif" }}>
              From product sourcing and Brand Registry to packaging, launch strategy, and margin math. Everything new and D2C sellers need to build a brand on Amazon India — in one playbook.
            </p>
            ...
            <div style={{ display:"flex", alignItems:"center", flexWrap:"wrap", gap:"8px 16px", marginBottom:32, fontSize: 13, color: resolvedTheme === 'dark' ? "#6b7280" : "#6B7280", fontFamily: "'Sora', sans-serif" }}>
              ...
              <span>·</span>
              <span style={{ background: "#E0E2FF", color: "#6366F1", fontWeight: 700, padding: "2px 10px", borderRadius: 4 }}>TOFU · New & D2C Sellers</span>
              <span style={{ background: "#DCFCE7", color: "#059669", fontWeight: 700, padding: "2px 10px", borderRadius: 4 }}>Marketplace Pillar</span>
            </div>
          ...
          <div className="lg:col-span-5 flex justify-center lg:justify-end">
            <div style={{ 
              ...
              <h4 style={{ fontSize: 10, fontWeight: 800, color: "#6B7280", letterSpacing: 1, textTransform: "uppercase", marginBottom: 20, textAlign: "center", fontFamily: "'Sora', sans-serif" }}>
                PRIVATE LABEL LAUNCH SNAPSHOT — AMAZON INDIA 2026
              </h4>
              
              <div className="grid grid-cols-2 gap-3 mb-6">
                {[
                  { val: "₹1.5L", lbl: "Min. budget", bg: resolvedTheme === 'dark' ? "#1f2937" : "#F8F9FF", col: "#6366F1" },
                  { val: "8-14 wks", lbl: "Time to sale", bg: resolvedTheme === 'dark' ? "#1f2937" : "#F3F4F6", col: "#7C3AED" },
                  { val: "30%+", lbl: "Target margin", bg: resolvedTheme === 'dark' ? "#1f2937" : "#F3F4F6", col: "#7C3AED" },
                  { val: "7 steps", lbl: "To live listing", bg: resolvedTheme === 'dark' ? "#1f2937" : "#F8F9FF", col: "#6366F1" },
                ].map((s, i) => (
                  <div key={i} style={{ background: s.bg, padding: "16px 12px", borderRadius: 16, textAlign: "center" }}>
                    <div style={{ fontSize: 20, fontWeight: 900, color: s.col, marginBottom: 2, fontFamily: "'Sora', sans-serif" }}>{s.val}</div>
                    <div style={{ fontSize: 9, fontWeight: 600, color: "#9CA3AF", textTransform: "uppercase", letterSpacing: 0.5, lineHeight: 1.2 }}>{s.lbl}</div>
                  </div>
                ))}
              </div>
              ...
              <div className="space-y-3 mb-6">
                {[
                  { label: "Brand Registry Required", value: "Yes — TM application" },
                  ...
                  <div key={i} className="flex justify-between items-center text-xs">
                    ...
                    <span style={{ color: resolvedTheme === 'dark' ? "white" : "#111827", fontWeight: "bold" }}>{row.value}</span>
                  </div>
                ))}
              </div>
              
              <div style={{ background: "linear-gradient(135deg, #7C3AED 0%, #6366F1 50%, #4F46E5 100%)", borderRadius: 14, padding: "16px 18px" }}>
                <p style={{ margin: 0, fontSize: 12, color: "white", lineHeight: 1.4, fontWeight: 500 }}>
                  The fastest way to build differentiation: analyse competitor reviews on Insydz before you brief your supplier. Their complaints are your product spec.
                </p>
              </div>
            </div>
          </div>
      ...
      <div style={{ maxWidth: 1240, margin: "0 auto", padding: "40px 16px 0" }}>
        ...
        <div style={{ 
          ...
          <p style={{ margin: 0, fontSize: 16, color: resolvedTheme === 'dark' ? "#d1d5db" : "#4B5563", lineHeight: 1.65, fontFamily: "'Lora', serif" }}>
            To launch a private label on Amazon India, pick a product category using sales rank and competitor review data, source from an Indian manufacturer on IndiaMart, register a trademark for Brand Registry, create an FBA listing with optimised copy, and launch with Sponsored Products and Amazon Vine. Minimum starting budget: <strong>₹1.5L to ₹3L</strong>.
          </p>
        </div>
        ...
        <main style={{ minWidth:0 }}>
          ...
          <article className="article-body">
            ...
            <h2 id="what-is-private-label" style={{ 
              ...
              What Exactly Is Private Label, and Why Is It the Right Model for Amazon India in 2026?
            </h2>
            
            <p style={{ color: resolvedTheme === 'dark' ? "#94a3b8" : "#4B5563", fontSize: "16px", lineHeight: 1.7, marginBottom: "20px", fontFamily: "'Lora', serif" }}>
              Private label means sourcing from a manufacturer, applying your own brand and packaging, and selling it as your own. You specify it, brand it, and own the customer relationship.
            </p>

            <p style={{ color: resolvedTheme === 'dark' ? "#94a3b8" : "#4B5563", fontSize: "16px", lineHeight: 1.7, marginBottom: "32px", fontFamily: "'Lora', serif" }}>
              Unlike reselling, private label builds equity. Your brand, your listing, your reviews — none of it can be taken away by another seller.
            </p>
            ...
            <div className="box box-purple" style={{ 
              ...
              <p style={{ margin:"0 0 16px", fontSize:15.5, color: resolvedTheme === 'dark' ? "#cbd5e1" : "#4B5563", lineHeight:1.75, fontFamily: "'Sora', sans-serif" }}>
                India's e-commerce penetration is still low in tier-2 and tier-3 cities — Jaipur, Surat, Coimbatore, Ludhiana. Buyers in these markets are moving online for the first time and have no established brand loyalty.
              </p>
              <p style={{ margin:0, fontSize:15.5, color: resolvedTheme === 'dark' ? "#cbd5e1" : "#4B5563", lineHeight:1.75, fontFamily: "'Sora', sans-serif" }}>
                A private label product with 30 reviews and good images beats a generic listing with zero brand identity every time. The window to build a brand before category saturation is still open in 2026.
              </p>
            </div>
            ...
            <div className="my-10">
              ...
              <p className="mt-4 text-center text-[13px] text-gray-400 italic font-medium font-sans px-4">
                Private label vs reselling on Amazon India — model comparison and top performing categories for new brand builders in 2026.
              </p>
            </div>
            ...
            <h2 id="product-selection" style={{ 
              ...
              How Do You Find the Right Product for Private Label on Amazon India?
            </h2>
            
            <p style={{ color: resolvedTheme === 'dark' ? "#94a3b8" : "#4B5563", fontSize: "16px", lineHeight: 1.7, marginBottom: "20px", fontFamily: "'Lora', serif" }}>
              Product selection determines whether your private label succeeds or fails. The framework Indian sellers use in 2026 combines demand validation with review gap analysis.
            </p>

            <p style={{ color: resolvedTheme === 'dark' ? "#94a3b8" : "#4B5563", fontSize: "16px", lineHeight: 1.7, marginBottom: "20px", fontFamily: "'Lora', serif" }}>
              Start with Amazon Best Sellers in categories where Indian manufacturers exist. Look for ASINs selling 200–800 units per month, priced ₹399–₹1,499, with under 200 reviews.
            </p>

            <p style={{ color: resolvedTheme === 'dark' ? "#94a3b8" : "#4B5563", fontSize: "16px", lineHeight: 1.7, marginBottom: "32px", fontFamily: "'Lora', serif" }}>
              Then read the 2-star and 3-star reviews. If 40% of the category leader's reviews mention "flimsy packaging" or "no Hindi instructions", those are the specs your product needs to beat.
            </p>
            ...
            <div className="box box-purple" style={{ 
              ...
              <p style={{ margin:0, fontSize:15.5, color: resolvedTheme === 'dark' ? "#cbd5e1" : "#4B5563", lineHeight:1.75, fontFamily: "'Sora', sans-serif" }}>
                Paste any ASIN into Insydz and you see the top complaint clusters for that product, ranked by frequency. Those complaints become your product differentiation brief before you brief your manufacturer.
              </p>
            </div>
            ...
            <div className="box box-amber" style={{ 
              ...
              <ul style={{ margin:0, padding:0, listStyle:"none" }} className="space-y-4">
                {[
                  ...
                  <li key={i} style={{ display:"flex", gap:12, fontSize:15, color: resolvedTheme === 'dark' ? "#cbd5e1" : "#4B5563", lineHeight:1.6, fontFamily: "'Lora', serif" }}>
                    <span style={{ color:"#D97706", fontSize:18, marginTop:-2 }}>•</span>
                    {item}
                  </li>
                ))}
              </ul>
            ...
            <h2 id="sourcing" style={{ 
              ...
              Where Do You Source Private Label Products in India, and How Do You Vet Suppliers?
            </h2>
            
            <p style={{ color: resolvedTheme === 'dark' ? "#94a3b8" : "#4B5563", fontSize: "16px", lineHeight: 1.7, marginBottom: "28px", fontFamily: "'Lora', serif" }}>
              Indian private label sellers have a structural advantage over Amazon.com sellers: your manufacturer is domestic. No import duties, no 12-week shipping delays, no minimum order quantities designed for Western importers.
            </p>

            <h4 style={{ 
              fontSize: "18px", fontWeight: 800, color: "#6366F1", marginBottom: "16px", fontFamily: "'Sora', sans-serif" 
            }}>Where to Find Manufacturers</h4>
            
            <p style={{ color: resolvedTheme === 'dark' ? "#94a3b8" : "#4B5563", fontSize: "16px", lineHeight: 1.7, marginBottom: "20px", fontFamily: "'Lora', serif" }}>
              IndiaMart and TradeIndia are the two primary directories. Search your category plus "OEM" or "white label" and filter for verified suppliers with GST registration.
            </p>

            <p style={{ color: resolvedTheme === 'dark' ? "#94a3b8" : "#4B5563", fontSize: "16px", lineHeight: 1.7, marginBottom: "20px", fontFamily: "'Lora', serif" }}>
              For kitchen and home try Rajkot or Surat; for fitness accessories, Pune; for textiles, Tiruppur.
            </p>

            <p style={{ color: resolvedTheme === 'dark' ? "#94a3b8" : "#4B5563", fontSize: "16px", lineHeight: 1.7, marginBottom: "32px", fontFamily: "'Lora', serif" }}>
              If you are within driving distance of the manufacturing cluster, visit the factory in person before committing to a production order.
            </p>
            ...
            <div className="box box-green" style={{ 
              ...
              <ul style={{ margin:0, padding:0, listStyle:"none" }} className="space-y-4">
                {[
                  ...
                  <li key={i} style={{ display:"flex", gap:12, fontSize:15, color: resolvedTheme === 'dark' ? "#cbd5e1" : "#4B5563", lineHeight:1.6, fontFamily: "'Lora', serif" }}>
                    <span style={{ color:"#10B981", fontSize:18, marginTop:-2 }}>•</span>
                    {item}
                  </li>
                ))}
              </ul>
            ...
            <p style={{ color: resolvedTheme === 'dark' ? "#94a3b8" : "#4B5563", fontSize: "16px", lineHeight: 1.7, marginBottom: "40px", fontFamily: "'Lora', serif" }}>
              Negotiate MOQs to 100–200 units for your first run — do not commit to 500+ units until your listing proves a conversion rate above 5%.
            </p>
            ...
            <div className="my-10">
              ...
              <p className="mt-4 text-center text-[13px] text-gray-400 italic font-medium font-sans px-4">
                Private label margin model for a ₹799 Amazon India product — COGS, FBA fees, commission, and ad spend calculated to a 39% net margin per unit sold.
              </p>
            </div>

            <h2 id="branding" style={{ 
              fontFamily: "'Sora', sans-serif",
              fontSize: "clamp(22px, 3vw, 28px)", 
              fontWeight: 900, 
              color: resolvedTheme === 'dark' ? "#f9fafb" : "#0A0F1A", 
              ...
              How Do You Register Your Brand and Get Amazon Brand Registry in India?
            </h2>
            
            <p style={{ color: resolvedTheme === 'dark' ? "#94a3b8" : "#4B5563", fontSize: "16px", lineHeight: 1.7, marginBottom: "32px", fontFamily: "'Lora', serif" }}>
              Brand Registry is the most important unlock in your private label journey — A+ Content (lifts conversion 3–10%), Amazon Vine access, and protection from listing hijackers.
            </p>

            <div className="space-y-4 mb-10">
              {[
                { n:1, t:"Pick a Brand Name — Check IP India First", d:"Search ipindia.gov.in to confirm your chosen name is available. Short, pronounceable names in both Hindi and English perform better with Indian buyers." },
                { n:2, t:"File Trademark in the Correct Class", d:"File on IP India in the class matching your product (Class 21 for kitchenware, Class 3 for personal care, etc). Cost: ₹4,500 for individuals. Application number issued immediately." },
                { n:3, t:"Apply on brandregistry.amazon.in", d:"Submit your brand name, trademark application number, and packaging photos showing the brand name. Amazon approves in 2–5 business days." },
                { n:4, t:"Unlock A+ Content, Vine, and Brand Analytics", d:"Once approved, build your A+ Content module immediately — it increases conversion by 3–10% and is free to create. Enrol in Amazon Vine India for your first batch of verified reviews." },
              ].map((s, i) => (
                <div key={i} style={{ 
                  background: resolvedTheme === 'dark' ? "#111827" : "white", 
                  border: resolvedTheme === 'dark' ? "1px solid #1f2937" : "1px solid #E5E7EB", 
                  borderRadius: 20, padding: "24px 28px", display: "flex", gap: 20, alignItems: "center"
                }}>
                  <div style={{ 
                  ...
                  <div style={{ flex: 1 }}>
                    <h4 style={{ margin: "0 0 4px", fontSize: 16, fontWeight: 800, color: resolvedTheme === 'dark' ? "#f9fafb" : "#111827", fontFamily: "'Sora', sans-serif" }}>{s.t}</h4>
                    <p style={{ margin: 0, fontSize: 14, color: resolvedTheme === 'dark' ? "#94a3b8" : "#64748B", lineHeight: 1.5 }}>{s.d}</p>
                  </div>
                </div>
              ))}
            </div>

            <h2 id="listing-optimization" style={{ 
              fontFamily: "'Sora', sans-serif",
              fontSize: "clamp(22px, 3vw, 28px)", 
              fontWeight: 900, 
              color: resolvedTheme === 'dark' ? "#f9fafb" : "#0A0F1A", 
              ...
              How Do You Create a Listing That Actually Converts for an Indian Buyer?
            </h2>
            
            <p style={{ color: resolvedTheme === 'dark' ? "#94a3b8" : "#4B5563", fontSize: "16px", lineHeight: 1.7, marginBottom: "32px", fontFamily: "'Lora', serif" }}>
              Indian buyers make 70%+ of purchase decisions on the primary image and star rating — before reading a word. A generic title and mediocre images will lose to a competitor with half your reviews but great visuals.
            </p>
            ...
            <div className="my-10">
              ...
              <p className="mt-4 text-center text-[13px] text-gray-400 italic font-medium font-sans px-4">
                Listing quality checklist for Amazon India private label — title structure, image count, A+ Content, and keyword fields that directly impact conversion and rank.
              </p>
            </div>
            ...
            <div className="tbl-wrap" style={{ 
              ...
              <table className="dt" style={{ width: "100%", borderCollapse: "collapse" }}>
                <thead style={{ 
                  ...
                  <tr>
                    <th style={{ color: "white", padding: "16px 20px", textAlign: "left", fontSize: 12, textTransform: "uppercase", letterSpacing: 1, fontFamily: "'Sora', sans-serif" }}>Listing Element</th>
                    <th style={{ color: "white", padding: "16px 20px", textAlign: "left", fontSize: 12, textTransform: "uppercase", letterSpacing: 1, fontFamily: "'Sora', sans-serif" }}>What To Do</th>
                    <th style={{ color: "white", padding: "16px 20px", textAlign: "right", fontSize: 12, textTransform: "uppercase", letterSpacing: 1, fontFamily: "'Sora', sans-serif" }}>Priority</th>
                  </tr>
                </thead>
                <tbody>
                  {[
                    { e: "Title", d: "Primary keyword in first 80 characters. Include brand name, material, size, and key use case.", p: "Critical", pc: "#FEE2E2", pt: "#991B1B", c: true },
                    { e: "Bullet Points", d: "5 bullets. Each starts with a capitalised benefit (not a feature). Mirror complaint vocabulary from competitor reviews.", p: "Critical", pc: "#FEE2E2", pt: "#991B1B", c: true },
                    { e: "Images", d: "7 minimum: hero (white background), lifestyle, infographic with key specs, size/dimension chart, and comparison vs generic alternative.", p: "Critical", pc: "#FEE2E2", pt: "#991B1B", c: true },
                    { e: "A+ Content", d: "Build immediately after Brand Registry approval. Brand story module + feature comparison table. Free to create, lifts conversion 3–10%.", p: "High", pc: "#FEF3C7", pt: "#92400E", c: false },
                    { e: "Backend Keywords", d: "Fill all 250 bytes of backend keyword fields. Include Hindi transliterations of your product name (e.g. \"pani ki bottle\" for water bottle).", p: "High", pc: "#FEF3C7", pt: "#92400E", c: false },
                    { e: "Product Description", d: "Add a Hindi paragraph at the end of the product description. Indian buyers from tier-2 cities respond significantly better to Hindi product descriptions.", p: "Medium", pc: "#F3E8FF", pt: "#6B21A8", c: false },
                  ].map((row, i) => (
                    <tr key={i} style={{ 
                      background: i % 2 === 0 ? (resolvedTheme === 'dark' ? "transparent" : "#F8FAFC") : "transparent",
                      borderBottom: resolvedTheme === 'dark' ? "1px solid #1f2937" : "1px solid #F1F5F9",
                      borderLeft: row.c ? "4px solid #8B5CF6" : "4px solid transparent"
                    }}>
                      <td style={{ padding: "18px 20px", fontWeight: 800, color: row.c ? "#8B5CF6" : (resolvedTheme === 'dark' ? "#f9fafb" : "#111827"), fontSize: 15, fontFamily: "'Sora', sans-serif" }}>{row.e}</td>
                      <td style={{ padding: "18px 20px", color: resolvedTheme === 'dark' ? "#94a3b8" : "#4B5563", fontSize: 14, lineHeight: 1.6, fontFamily: "'Sora', sans-serif" }}>{row.d}</td>
                      <td style={{ padding: "18px 20px", textAlign: "right" }}>
                        <span style={{ 
                          background: resolvedTheme === 'dark' ? (row.p === 'Critical' ? "#450a0a" : row.p === 'High' ? "#451a03" : "#2e1065") : row.pc, 
                          color: resolvedTheme === 'dark' ? (row.p === 'Critical' ? "#fecaca" : row.p === 'High' ? "#fef3c7" : "#f3e8ff") : row.pt,
                          padding: "4px 12px", borderRadius: 12, fontSize: 11, fontWeight: 700, textTransform: "capitalize"
                        }}>
                          {row.p}
                        </span>
                      </td>
            ...
            <h2 id="launch-strategy" style={{ 
              ...
              What Is the Right Launch Strategy for a New Private Label on Amazon India?
            </h2>
            
            <p style={{ color: resolvedTheme === 'dark' ? "#94a3b8" : "#4B5563", fontSize: "16px", lineHeight: 1.7, marginBottom: "32px", fontFamily: "'Lora', serif" }}>
              Launching without a plan is the most common reason private label products fail. Most sellers list, wait for organic sales, get no reviews, and quit within 30 days. The 4-week launch window is the most critical period your product will ever have.
            </p>

            <div className="space-y-4 mb-10">
              {[
                { n:1, t:"Enrol in Amazon Vine India on Day One", d:"As soon as your listing is live with FBA inventory, enrol in Vine (₹19,200 for up to 30 reviews). This is non-negotiable for a private label launch. You need social proof before organic buyers arrive." },
                { n:2, t:"Run Sponsored Products at a Higher Bid for Weeks 1–4", d:"Run an auto campaign and 2 manual exact-match campaigns on your top 5 keywords. Accept higher ACoS in weeks 1–4 to build rank, then optimise for profitability from week 5." },
                { n:3, t:"Share Your Listing on WhatsApp Before Going Live", d:"Tell your network — customers, friends, colleagues — via WhatsApp that the product is live. Even 10–15 organic sales in week 1 signal relevance to Amazon's algorithm." },
                { n:4, t:"Track Keyword Rank Daily from Week 1", d:"Use Insydz to track daily rank on your target keywords. Know when you cross threshold positions (#50, #30, #15) and which actions drove each jump." },
                { n:5, t:"Respond to Every Review in Weeks 1–8", d:"Respond publicly to every 3-star or below review with a resolution offer. It shows future buyers you stand behind the product — and often prompts rating updates." },
              ].map((s, i) => (
                <div key={i} style={{ 
                  background: resolvedTheme === 'dark' ? "#111827" : "white", 
                  border: resolvedTheme === 'dark' ? "1px solid #3b0764" : "1px solid #e9d5ff", 
                  borderRadius: 20, padding: "24px 28px", display: "flex", gap: 20, alignItems: "center",
                  boxShadow: resolvedTheme === 'dark' ? "none" : "0 4px 14px rgba(139, 92, 246, 0.03)"
                }}>
                  <div style={{ 
                    background: "#8B5CF6", color: "white", width: 36, height: 36, borderRadius: "50%", 
                    display: "flex", alignItems: "center", justifyContent: "center", fontWeight: 900, fontSize: 16, flexShrink: 0 
                  }}>
                    {s.n}
                  </div>
            ...
            <div style={{ 
              ...
              borderRadius: 24, padding: "32px 40px", marginBottom: "48px",
              ...
              <div style={{ flex: "1 1 400px" }}>
                ...
                <p style={{ color: "#94a3b8", fontSize: 15, margin: 0, lineHeight: 1.6 }}>
                  See exactly which keywords move as your reviews and sales build — Insydz tracks daily on Amazon India and Flipkart.
                </p>
              </div>
              <button style={{ 
                background: "#8B5CF6", color: "white", border: "none", padding: "14px 28px", 
                borderRadius: 100, fontSize: 15, fontWeight: 700, cursor: "pointer", whiteSpace: "nowrap",
            ...
            <h2 id="scaling" style={{ color: resolvedTheme === 'dark' ? "#f9fafb" : "#0A0F1A", borderColor: resolvedTheme === 'dark' ? "#1f2937" : "#E5E7EB" }}>Scaling: From 1 ASIN to a Full Brand</h2>
            <p style={{ color: resolvedTheme === 'dark' ? "#d1d5db" : "#1E293B" }}>
              Once your first product is generating ₹2L in monthly profit, don't just sit on it. Reinvest that profit into your next product. A "brand" is a collection of complementary products that solve a specific customer problem.
            </p>
            ...
            <h2 id="common-pitfalls" style={{ 
              ...
              What Are the Most Common Mistakes New Private Label Sellers Make on Amazon India?
            </h2>
            ...
            <div className="space-y-4 mb-10">
              {[
                { n:1, t:"Choosing a Product Based on Interest, Not Data", d:"Sellers pick categories they personally use. Private label is a data decision — validated demand, weak reviews, local sourcing. Personal interest is irrelevant." },
                { n:2, t:"Ordering 500 Units Before Validating Conversion", d:"Start with 150–200 units. Prove a conversion rate above 5% before reordering at scale. Ordering 500+ units of an unproven listing is an ₹80,000–₹1,50,000 gamble." },
                { n:3, t:"Launching Without Brand Registry", d:"Without Brand Registry, any seller can add themselves to your listing. You lose control of pricing and reviews. File your trademark application before sending inventory to FBA." },
                { n:4, t:"Skipping Hindi in the Listing", d:"Buyers in Patna, Nagpur, Rajkot, and Mysore convert better with Hindi in the product description. It is a 15-minute update that lifts conversion in tier-2 and tier-3 markets." },
                { n:5, t:"Not Tracking Rank After Launch", d:"Most sellers check sales numbers and guess if the launch is working. Daily keyword rank tracking tells you exactly whether ads, Vine reviews, and listing edits are moving you in the right direction." },
              ].map((s, i) => (
                <div key={i} style={{ 
                  display: "flex",
                  background: resolvedTheme === 'dark' ? "#111827" : "white", 
                  ...
                  <div style={{ 
                    background: resolvedTheme === 'dark' ? "#1e293b" : "#0F172A", 
                    color: "white", width: 54, 
                    display: "flex", alignItems: "center", justifyContent: "center", 
                    fontWeight: 900, fontSize: 18, flexShrink: 0, fontFamily: "'Sora', sans-serif"
                  }}>
                    {s.n}
                  </div>
            ...
            <h2 id="tools-required" style={{ 
              ...
              Which Tool Should You Use to Track and Grow Your Private Label on Amazon India?
            </h2>
            
            <p style={{ color: resolvedTheme === 'dark' ? "#94a3b8" : "#4B5563", fontSize: "16px", lineHeight: 1.7, marginBottom: "32px", fontFamily: "'Lora', serif" }}>
              Once live, the work shifts to rank tracking, review analysis, and competitor monitoring. Here is how tools compare for Indian private label sellers.
            </p>
            ...
            <div className="tbl-wrap" style={{ 
              ...
              <table className="dt" style={{ width: "100%", minWidth: "800px", borderCollapse: "collapse", textAlign: "center" }}>
                <thead style={{ background: resolvedTheme === 'dark' ? "#1e293b" : "#0F172A", color: "white" }}>
                  <tr>
                    <th style={{ padding: "16px 20px", textAlign: "left", fontSize: 12, textTransform: "uppercase", letterSpacing: 1, fontFamily: "'Sora', sans-serif" }}>Capability</th>
                    <th style={{ background: "#7C3AED", padding: "16px 20px", fontSize: 12, textTransform: "uppercase", letterSpacing: 1, fontFamily: "'Sora', sans-serif" }}>Insydz</th>
                    <th style={{ padding: "16px 20px", fontSize: 12, textTransform: "uppercase", letterSpacing: 1, fontFamily: "'Sora', sans-serif" }}>Helium 10</th>
                    <th style={{ padding: "16px 20px", fontSize: 12, textTransform: "uppercase", letterSpacing: 1, fontFamily: "'Sora', sans-serif" }}>Jungle Scout</th>
                    <th style={{ padding: "16px 20px", fontSize: 12, textTransform: "uppercase", letterSpacing: 1, fontFamily: "'Sora', sans-serif" }}>Viral Launch</th>
                  </tr>
                </thead>
                <tbody>
                  {[
                    { c: "Amazon India keyword rank tracking", i: {t:"✓ Native", p:"g"}, h: {t:"Limited", p:"y"}, j: {t:"US focus", p:"r"}, v: {t:"US focus", p:"r"} },
                    { c: "Flipkart rank tracking", i: {t:"✓ Yes", c:"g"}, h: {t:"No", c:"r"}, j: {t:"No", c:"r"}, v: {t:"No", c:"r"} },
                    { c: "Competitor review analysis", i: {t:"✓ AI-powered", p:"g"}, h: {t:"Basic", p:"y"}, j: {t:"Basic", p:"y"}, v: {t:"Limited", p:"r"} },
                    { c: "Hindi review analysis", i: {t:"✓ Yes", c:"g"}, h: {t:"No", c:"r"}, j: {t:"No", c:"r"}, v: {t:"No", c:"r"} },
                    { c: "Pricing for Indian sellers", i: {t:"₹0-₹4,999/mo", p:"g"}, h: {t:"₹7,000+/mo", p:"r"}, j: {t:"₹5,500+/mo", p:"r"}, v: {t:"₹5,000+/mo", p:"r"} },
                    { c: "India-first support", i: {t:"✓ WhatsApp", c:"g"}, h: {t:"Email only", c:"gy"}, j: {t:"Email only", c:"gy"}, v: {t:"Email only", c:"gy"} },
                  ].map((row, i) => (
                    <tr key={i} style={{ 
                      background: i % 2 === 0 ? (resolvedTheme === 'dark' ? "transparent" : "#F8FAFC") : "transparent",
                      borderBottom: resolvedTheme === 'dark' ? "1px solid #1f2937" : "1px solid #F1F5F9"
                    }}>
                      <td style={{ padding: "18px 20px", textAlign: "left", fontWeight: 700, color: resolvedTheme === 'dark' ? "#f9fafb" : "#111827", fontSize: 14, fontFamily: "'Sora', sans-serif" }}>{row.c}</td>
                      
                      {/* INSYDZ Column */}
                      <td style={{ 
                        padding: "18px 20px", 
                        borderLeft: resolvedTheme === 'dark' ? "1px solid #3b0764" : "1px solid #e9d5ff",
                        borderRight: resolvedTheme === 'dark' ? "1px solid #3b0764" : "1px solid #e9d5ff",
                        background: resolvedTheme === 'dark' ? "#2e106510" : "#f3e8ff30"
                      }}>
                        {row.i.p ? (
                          <span style={{ 
                            background: row.i.p === 'g' ? (resolvedTheme === 'dark' ? "#064e3b" : "#dcfce7") : "", 
                            color: row.i.p === 'g' ? (resolvedTheme === 'dark' ? "#a7f3d0" : "#166534") : "",
                            padding: "4px 12px", borderRadius: 12, fontSize: 12, fontWeight: 700
                          }}>{row.i.t}</span>
                        ) : (
                          <span style={{ 
                            color: row.i.c === 'g' ? (resolvedTheme === 'dark' ? "#34d399" : "#059669") : "",
                      ...
                      <td style={{ padding: "18px 20px" }}>
                         {row.h.p ? (
                          <span style={{ 
                            background: row.h.p === 'y' ? (resolvedTheme === 'dark' ? "#451a03" : "#fef08a") : row.h.p === 'r' ? (resolvedTheme === 'dark' ? "#450a0a" : "#fee2e2") : "", 
                            color: row.h.p === 'y' ? (resolvedTheme === 'dark' ? "#fde047" : "#854d0e") : row.h.p === 'r' ? (resolvedTheme === 'dark' ? "#fca5a5" : "#991b1b") : "",
                            padding: "4px 12px", borderRadius: 12, fontSize: 12, fontWeight: 700
                          }}>{row.h.t}</span>
                        ) : (
                          <span style={{ 
                            color: row.h.c === 'r' ? (resolvedTheme === 'dark' ? "#f87171" : "#dc2626") : row.h.c === 'gy' ? (resolvedTheme === 'dark' ? "#94a3b8" : "#64748b") : "",
                            fontSize: 13, fontWeight: 700
                          }}>{row.h.t}</span>
                        )}
                      </td>
                      ...
                      <td style={{ padding: "18px 20px" }}>
                         {row.j.p ? (
                          <span style={{ 
                            background: row.j.p === 'y' ? (resolvedTheme === 'dark' ? "#451a03" : "#fef08a") : row.j.p === 'r' ? (resolvedTheme === 'dark' ? "#450a0a" : "#fee2e2") : "", 
                            color: row.j.p === 'y' ? (resolvedTheme === 'dark' ? "#fde047" : "#854d0e") : row.j.p === 'r' ? (resolvedTheme === 'dark' ? "#fca5a5" : "#991b1b") : "",
                            padding: "4px 12px", borderRadius: 12, fontSize: 12, fontWeight: 700
                          }}>{row.j.t}</span>
                        ) : (
                          <span style={{ 
                            color: row.j.c === 'r' ? (resolvedTheme === 'dark' ? "#f87171" : "#dc2626") : row.j.c === 'gy' ? (resolvedTheme === 'dark' ? "#94a3b8" : "#64748b") : "",
                            fontSize: 13, fontWeight: 700
                          }}>{row.j.t}</span>
                        )}
                      </td>
                      ...
                      <td style={{ padding: "18px 20px" }}>
                         {row.v.p ? (
                          <span style={{ 
                            background: row.v.p === 'y' ? (resolvedTheme === 'dark' ? "#451a03" : "#fef08a") : row.v.p === 'r' ? (resolvedTheme === 'dark' ? "#450a0a" : "#fee2e2") : "", 
                            color: row.v.p === 'y' ? (resolvedTheme === 'dark' ? "#fde047" : "#854d0e") : row.v.p === 'r' ? (resolvedTheme === 'dark' ? "#fca5a5" : "#991b1b") : "",
                            padding: "4px 12px", borderRadius: 12, fontSize: 12, fontWeight: 700
                          }}>{row.v.t}</span>
                        ) : (
                          <span style={{ 
                            color: row.v.c === 'r' ? (resolvedTheme === 'dark' ? "#f87171" : "#dc2626") : row.v.c === 'gy' ? (resolvedTheme === 'dark' ? "#94a3b8" : "#64748b") : "",
                            fontSize: 13, fontWeight: 700
                          }}>{row.v.t}</span>
                        )}
                      </td>
            ...
            <div className="my-10">
              ...
              <p className="mt-4 text-center text-[13px] text-gray-400 italic font-medium font-sans px-4">
                Insydz rank tracking for a private label yoga mat launch on Amazon India — from invisible (#72) to top-20 in 6 weeks, with rank jumps correlated to Vine reviews and listing changes.
              </p>
            </div>
      ...
      <div style={{ 
        ...
        <div style={{ position: "relative", zIndex: 1, maxWidth: 720, margin: "0 auto" }}>
          <h2 style={{ 
            fontFamily: "'Sora', sans-serif", fontSize: "clamp(24px, 4vw, 36px)", fontWeight: 900, 
            color: "white", lineHeight: 1.2, letterSpacing: "-0.5px", marginBottom: 16 
          }}>
          ...
          <p style={{ 
            ...
            color: "rgba(255,255,255,0.85)", lineHeight: 1.6, maxWidth: 580, margin: "0 auto 28px" 
          }}>
            Start by analysing competitor reviews in your target category — Insydz shows you the exact product gaps your private label should solve.
          </p>
          
          <div style={{ 
            display: "flex", flexWrap: "wrap", justifyContent: "center", gap: "8px 24px", 
            marginBottom: 32, fontSize: 13, color: "rgba(255,255,255,0.9)", fontFamily: "'Sora', sans-serif", fontWeight: 500 
          }}>
            {["Amazon India & Flipkart rank tracking", "AI competitor review analysis", "Hindi review processing", "Free to start"].map((f, i) => (
          ...
          <p style={{ 
            marginTop: 20, fontSize: 12, color: "rgba(255,255,255,0.6)", 
