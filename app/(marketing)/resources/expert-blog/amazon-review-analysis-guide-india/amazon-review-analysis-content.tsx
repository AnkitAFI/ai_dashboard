...
export default function AmazonReviewAnalysisContent() {
    ...
    <div className="dash-mockup">
      ...
      <div className="dash-alert">
        <div className="alert-content">
          <strong>Sentiment Alert:</strong> "Battery drains in 4 hours"
          mentioned in 18 reviews this week — recommend updating bullet 2 with
          realistic playback claim. Estimated rating recovery:{" "}
          <span className="text-up">+0.3</span>
        </div>
        <button onClick={() => router.push("/login")} className="alert-btn">
          Apply Fix
        </button>
      </div>
    </div>
    ...
    return (
      <div className="relative">
        <button
          ...
          className={`px-2 xl:px-3 py-2 text-xs xl:text-sm font-medium rounded-lg transition-all flex items-center gap-1 ${isActive ? (ac ? "text-orange-600 font-semibold" : "text-purple-600 font-semibold") : "text-gray-700 dark:text-gray-300 hover:text-purple-600 hover:bg-purple-50 dark:hover:bg-purple-900/20"}`}
        >
          {label}
          <ChevronDown
          ...
          >
            {items.map((item, i) => (
              ...
              >
                ...
                <span className="text-xs xl:text-sm text-gray-700 dark:text-gray-300 flex-1">
                  {item.name}
                </span>
                {item.badge && (
                  <span className="text-xs bg-gradient-to-r from-purple-600 to-pink-600 text-white px-1.5 py-0.5 rounded-full font-semibold">
                    {item.badge}
                  </span>
                )}
              </button>
  ...
  const compRows = [
    ...
    },
    {
      ...
      insydz: "Native integration",
    },
    {
      cap: "Hindi & Hinglish Processing",
      manual: "No",
      global: "English only",
      insydz: "Native NLP for both",
    },
    {
      cap: "WhatsApp Alerts",
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950 transition-colors">
      ...
      <div className="pt-24 bg-white dark:bg-gray-950">
        ...
        >
          ...
          <span className="text-slate-600 dark:text-slate-400 font-medium">
            Analyze Amazon Reviews Tool India
          </span>
        </div>
      </div>
      ...
      <div style={{ maxWidth: 1240, margin: "0 auto", padding: "40px 24px 0" }}>
        ...
        >
          How to <span className="text-gradient">Analyze Amazon Reviews</span>{" "}
          <br />
          Fast (2026 Guide)
        </h1>
        <p
        ...
        >
          AI-powered review mining for Amazon India and Flipkart to surface
          buyer pain points and competitor weaknesses before your next listing
          update.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mt-12 mb-14">
          <div className="p-6 rounded-2xl border border-slate-100 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-sm transition-all hover:shadow-md group">
            <div
              className="text-3xl font-extrabold text-purple-600 dark:text-purple-400 mb-2 group-hover:scale-105 transition-transform origin-left"
              style={{ fontFamily: "'Sora', sans-serif" }}
            >
              1,000+
            </div>
            <p className="text-xs lg:text-[13px] text-slate-500 dark:text-slate-400 leading-relaxed font-medium">
              Reviews analyzed in &lt; 5 min by AI tools — vs 8 hours manually
            </p>
          </div>
          <div className="p-6 rounded-2xl border border-slate-100 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-sm transition-all hover:shadow-md group">
            <div
            ...
            <p className="text-xs lg:text-[13px] text-slate-500 dark:text-slate-400 leading-relaxed font-medium">
              Indian D2C RTO rates — most are review-signalled before they spike
            </p>
          </div>
          <div className="p-6 rounded-2xl border border-slate-100 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-sm transition-all hover:shadow-md group">
            <div
            ...
            <p className="text-xs lg:text-[13px] text-slate-500 dark:text-slate-400 leading-relaxed font-medium">
              Annual loss on a ₹10Cr brand at 25% RTO — review mining cuts it
            </p>
          </div>
          <div className="p-6 rounded-2xl border border-slate-100 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-sm transition-all hover:shadow-md group">
            <div
            ...
            <p className="text-xs lg:text-[13px] text-slate-500 dark:text-slate-400 leading-relaxed font-medium">
              Festive orders from Tier 2/3 — different review patterns than
              metros
            </p>
          </div>
        </div>
      ...
      <div className="article-layout">
        <aside className="toc-sidebar">
          <h4
            className="text-[11px] font-bold uppercase tracking-widest text-slate-500 mb-4"
            style={{ fontFamily: "'Sora', sans-serif" }}
          >
            Table of Contents
          </h4>
        ...
        <main className="article-body">
          <div className="box box-blue">
            ...
            <p className="text-[15px] leading-relaxed text-slate-700 dark:text-slate-300">
              Instead of reading thousands of Amazon reviews to figure out why
              your conversions dropped or why returns are spiking, an Amazon
              review analysis tool reads them for you — clustering complaints by
              theme, ranking pain points by frequency and revenue impact, and
              flagging the exact phrases your buyers (and your competitors'
              buyers) keep repeating.
            </p>
          </div>
          ...
          <p>
            ...
            <strong className="text-slate-900 dark:text-white font-bold">
              analyze Amazon reviews tool
            </strong>{" "}
            is software that ingests every review on a product listing — yours
            and your competitors' — and uses NLP to extract structured
            intelligence: sentiment polarity, theme clusters, feature requests,
            recurring complaints, and language patterns. Instead of scrolling
            through 800 reviews and guessing, you get a ranked list of what
            buyers actually love, hate, and wish you'd build.
            <br />
            <br />
            For Indian D2C sellers, the unlock is bigger than for US sellers.
            Indian reviewers post in English, Hindi, Hinglish, and
            transliterated Tamil and Telugu — and they complain about things
            US-trained models often miss: courier handling damage, COD-driven
            trial purchases that come back, GST receipt confusion, and packaging
            that survives a Mumbai monsoon but not a Lucknow one.
            <br />
            <br />
            Modern tools go further than sentiment scoring. They cluster the
            1,247 reviews on your wireless earbuds listing into 14 themes, rank
            them by how often they correlate with 1- and 2-star ratings, and
            tell you which three fixes would move your average rating from 4.1
            to 4.4. That's review mining — and it's the fastest path from
            customer voice to listing copy that converts.
          </p>
          ...
          />
          <h3
            className="text-lg font-bold text-slate-900 dark:text-white mt-8 mb-4"
            style={{ fontFamily: "'Sora', sans-serif" }}
          >
            India's Returns Reality Hides in the Reviews
          </h3>
          <p>
            Indian e-commerce runs on a brutal RTO economics: return-to-origin
            rates of 25–35% are common for COD-heavy categories, and during
            festive quarters COD returns can hit 58%. A ₹10 crore D2C brand at
            25% RTO loses roughly ₹3.25 crore a year to failed deliveries and
            returns — and a third of those returns are seeded by complaints
            already buried in your existing reviews.
          </p>
          <p>
            Manual review reading misses the pattern. Your team sees individual
            1-star reviews and replies one at a time. A review analysis tool
            sees that 22% of negative reviews from pin codes outside metros
            mention "package was damaged" — which means your bubble wrap spec is
            fine for Bangalore but not for Bareilly, and that's a packaging SKU
            change worth ₹40,000 per crore in retained revenue.
          </p>
          ...
          <div className="box box-yellow">
            ...
            <p className="text-[15px] leading-relaxed text-slate-700 dark:text-slate-300">
              A Mumbai-based home appliances D2C brand was running ₹85L/month on
              Amazon.in with a 4.2 average. Returns hit 28%. Manual review
              reading turned up nothing actionable. AI clustering surfaced one
              theme: 31% of 1-star reviews mentioned "missing manual" — buyers
              in Tier 2 cities couldn't operate the product without printed
              instructions. They added a QR-code printed insert in eight
              languages. Within 6 weeks: returns dropped to 19%, rating climbed
              to 4.5, and conversion rate lifted 14%.
            </p>
          </div>
          ...
          <p>
            Your competitors' 1-star reviews are the cheapest market research
            you'll ever do. When 47 buyers complain that the rival earbuds
            "disconnect during Wynk Music" or that a competing kurta "runs small
            for Indian sizing," that's not noise — that's your next ad headline,
            your next bullet point, your next product tweak. Most Indian sellers
            never read competitor reviews systematically because the volume is
            overwhelming. AI clustering changes the math entirely.
          </p>
          ...
          <p>
            ...
            category-annual revenue concentrates into a 4–7 day window. Review
            velocity in that window — both yours and your top three competitors'
            — is the closest thing to a real-time demand signal you'll get on
            Amazon.in. A spike in negative reviews on day 2 of BBD usually
            predicts the exact moment a competitor will pull ad spend; that's
            your window to surge.
          </p>
          ...
          <p>
            Amazon's ranking algorithm factors review velocity, sentiment, and
            recency into rank position. Listings with declining sentiment slide
            silently in search results — and most sellers only notice when
            monthly revenue drops 15%. Continuous review monitoring catches
            sentiment drift on day 3, not week 8.
          </p>

          <div className="box box-blue">
            <div className="flex items-center gap-2 text-[#3B82F6] dark:text-blue-400 text-[11px] font-black uppercase tracking-wider mb-2">
              <LayoutGrid className="w-3.5 h-3.5 fill-current" /> AI OVERVIEW
              SUMMARY
            </div>
            <p className="text-[15px] leading-relaxed text-slate-700 dark:text-slate-300">
              Amazon review analysis tools help Indian D2C sellers cluster
              customer sentiment by theme, identify RTO-driving complaints, mine
              competitor pain points, and surface festive-season demand signals
              across Amazon.in and Flipkart — replacing 8 hours of manual review
              reading with a 5-minute automated dashboard.
            </p>
          </div>

          <h2 id="ai-loop">How Does AI Amazon Review Analysis Work?</h2>
          <p>
            Modern review analysis tools have replaced the manual spreadsheet
            workflow with an automated 5-step intelligence loop:
          </p>
          ...
          <div className="space-y-6 my-10">
            {[
              ...
              <div
                key={item.step}
                className="p-6 rounded-2xl border border-slate-100 dark:border-slate-800 bg-white dark:bg-slate-900/50 shadow-sm transition-all hover:shadow-md"
              >
                <div className="flex gap-4">
                  <div className="w-8 h-8 rounded-full bg-purple-600 text-white flex items-center justify-center font-bold shrink-0 text-sm">
                    {item.step}
                  </div>
                  <div>
                    <h4
          ...
          <div className="box box-purple">
            ...
            <p className="text-[15px] leading-relaxed text-slate-700 dark:text-slate-300">
              Sentiment without clustering is theatre. Knowing "42% of reviews
              are negative" tells you nothing you can act on. Knowing "31% of
              negative reviews mention 'missing manual', concentrated in pin
              codes 226001–226021" tells you exactly what to fix and where.
            </p>
          </div>
          ...
          <p>
            Not all review data is equal. The clusters that move revenue are the
            ones tied to fixable listing or product changes — and Indian sellers
            using global tools usually miss the highest-conversion categories
            entirely.
          </p>
          ...
          <div className="tbl-wrap">
            <table className="dt">
              ...
              <tbody>
                {[
                  {
                    type: "RTO Trigger Themes",
                    example: '"Wrong size," "Different from photo"',
                    volume: "High",
                    impact: "Very High (returns)",
                    priority: "Critical",
                    color: "red",
                  },
                  {
                    type: "Packaging & Transit",
                    example: '"Bottle leaked," "Box crushed"',
                    volume: "Medium",
                    impact: "High (Tier 2/3 specific)",
                    priority: "Critical",
                    color: "red",
                  },
                  {
                    type: "Feature Requests",
                    example: '"Should have come with charger"',
                    volume: "Medium",
                    impact: "Medium (next SKU)",
                    priority: "Important",
                    color: "orange",
                  },
                  {
                    type: "Competitor Comparisons",
                    example: '"boAt is better at this price"',
                    volume: "Low-Medium",
                    impact: "High (positioning)",
                    priority: "Important",
                    color: "orange",
                  },
                  {
                    type: "Regional Language Pain Points",
                    example: '"Manual Hindi mein nahi hai"',
                    volume: "Growing",
                    impact: "High (Tier 2/3)",
                    priority: "Opportunity",
                    color: "green",
                  },
                  {
                    type: "Festive-Specific Complaints",
                    example: '"Ordered for Diwali, came after"',
                    volume: "Spike",
                    impact: "Very High (BBD/GIF)",
                    priority: "Critical",
                    color: "red",
                  },
                ].map((r, i) => (
                  <tr key={i}>
                    ...
                    <td className="text-slate-500 italic text-[13px]">
                      {r.example}
                    </td>
          ...
          <p className="art-img-cap">
            Six review insight categories Indian sellers must track — ranked by
            RTO impact and competitive opportunity.
          </p>
          ...
          <p>
            Each of these mistakes silently costs Indian sellers conversion,
            rank, and margin every week they go uncorrected.
          </p>
          ...
          <div className="space-y-6 my-10">
            {[
              ...
              >
                <div className="flex gap-4">
                  <div className="w-8 h-8 rounded-lg bg-slate-900 dark:bg-white text-white dark:text-slate-900 flex items-center justify-center font-bold shrink-0 text-sm">
                    {item.step}
                  </div>
                  <div>
                    <h4
          ...
          <div className="tbl-wrap">
            <table className="dt">
              ...
              <tbody>
                {[
                  {
                    method: "Manual Review Reading",
                    speed: "8–12 hrs",
                    speedColor: "text-red-500",
                    data: "Partial (skim only)",
                    action: "Low — anecdotal",
                    cost: "3–4 hrs/week labour",
                    recommended: false,
                  },
                  {
                    method: "ChatGPT + CSV Export",
                    speed: "2–3 hrs",
                    speedColor: "text-orange-500",
                    data: "Limited (US bias)",
                    action: "Medium — one-shot",
                    cost: "₹0–₹1,500/mo",
                    recommended: false,
                  },
                  {
                  ...
                  },
                  {
                    ...
                    data: "Amazon.in + Flipkart + Hinglish",
                  ...
                  <tr key={i}>
                    <td>
                      <div>
                        <span
                          className={`font-bold ${r.recommended ? "text-purple-600 dark:text-purple-400" : "text-slate-800 dark:text-slate-200"}`}
                        >
                          {r.method}
                        </span>
                        {r.recommended && (
                          <span className="ml-2 inline-block px-2 py-0.5 rounded-full text-[10px] font-bold bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400 uppercase">
                            Recommended
                          </span>
                        )}
                      </div>
                    </td>
                    <td className={`font-semibold ${r.speedColor}`}>
                      {r.speed}
                    </td>
                    <td className="text-slate-600 dark:text-slate-400">
                      {r.data}
          ...
          <p className="art-img-cap">
            Review analysis methods compared — sorted by speed, data fit for
            India, and actionability of output.
          </p>

          <div className="box box-purple">
            <div className="flex items-center gap-2 text-purple-600 dark:text-purple-600 text-[11px] font-black uppercase tracking-wider mb-2">
              EVERY WEEK YOU WAIT
            </div>
            <p className="text-[15px] leading-relaxed text-slate-700 dark:text-slate-300">
              Every week without structured review analysis is a week of buyer
              complaints silently bleeding into rank position, ad spend, and RTO
              — while your competitor's analyst spots the same patterns and
              moves first.
            </p>
          </div>
          ...
          <p>
            The Indian D2C founders who get the most out of review analysis
            don't run it as a quarterly project. They build a
            daily–weekly–monthly rhythm that compounds insights into listing
            edits without requiring a dedicated analyst.
          </p>
              ...
              <div className="space-y-2 pl-12">
                {[
                  ...
                  <div key={i} className="flex items-start gap-2">
                    <span className="text-purple-600 dark:text-purple-400 mt-0.5 font-bold">
                      ✓
                    </span>
          ...
          <h3
            className="text-lg font-bold text-slate-900 dark:text-white mt-12 mb-6"
            style={{ fontFamily: "'Sora', sans-serif" }}
          >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 my-6">
            {[
              {
                color: "bg-blue-400",
                title: "Negative Theme Concentration",
                desc: "What % of negative reviews are driven by your top 3 clusters? Target: keep below 50%. Above that means one fix will move the needle.",
              },
              {
                color: "bg-purple-400",
                title: "Sentiment Drift (90-day)",
                desc: "Direction of average rating across rolling 90 days — leading indicator of rank changes 4–6 weeks later.",
              },
              {
                color: "bg-blue-400",
                title: "Competitor Pain-Gap Count",
                desc: "How many themes your competitor's buyers complain about that your product solves but your listing doesn't say. Target: under 3.",
              },
              {
                color: "bg-purple-400",
                title: "Listing Edit Velocity",
                desc: "Number of bullet/A+ updates per ASIN per quarter driven by review insights. Target: minimum 4.",
              },
              {
                color: "bg-blue-400",
                title: "RTO–Review Correlation",
                desc: "% of returned orders whose pain point was already mentioned in reviews 30+ days prior. Target: under 15%.",
              },
              {
                color: "bg-purple-400",
                title: "Hinglish Coverage Rate",
                desc: "% of reviews correctly classified by your tool when written in Hinglish or transliterated regional languages. Target: above 90%.",
              },
            ].map((m, i) => (
              <div
                key={i}
                className="p-5 rounded-2xl border border-slate-100 dark:border-slate-800 bg-white dark:bg-slate-900/50 shadow-sm"
              >
          ...
          <div className="internal-cta">
            ...
            <p>
              Connect Amazon.in & Flipkart. Get your first sentiment-cluster
              report today. WhatsApp alerts on negative theme spikes included.
            </p>
            <Button
          ...
          <p className="mb-8">
            Helium 10's Review Insights and Jungle Scout's review tools were
            built around Amazon.com sentiment patterns and English-only review
            text. Adapting them for India means your sentiment scores get
            distorted by Hinglish reviews flagged as neutral, your Flipkart
            reviews are simply absent, and your RTO-driving complaints — which
            look very different from the US returns profile — get clustered
            under the wrong themes.
          </p>
            ...
            <table className="dt">
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <span className="p-badge p-orange">Partial</span>
                  </td>
                  <td>
                    <span className="p-badge p-red">No</span>
                  </td>
                  <td>
                    <span className="p-badge p-red">No</span>
                  </td>
                ...
                <tr>
                  ...
                  <td>
                    <span className="p-badge p-green">Yes</span>
                  </td>
                  <td>
                    <span className="p-badge p-red">No</span>
                  </td>
                  <td>
                    <span className="p-badge p-orange">Limited</span>
                  </td>
                  <td>
                    <span className="p-badge p-red">Email only</span>
                  </td>
                  <td className="text-slate-600 dark:text-slate-400">
                    ₹2,500–6,000
                  </td>
                ...
                <tr className="bg-purple-50/50 dark:bg-purple-900/10">
                  ...
                  <td>
                    <span className="p-badge p-green">Native</span>
                  </td>
                  <td>
                    <span className="p-badge p-green">&lt; 60 min</span>
                  </td>
          ...
          <div className="tbl-wrap">
            <table className="dt">
              <thead className="bg-[#0b0f1a] text-white">
                <tr>
                  <th className="bg-[#0b0f1a] text-white text-xs font-semibold tracking-wide uppercase px-4 py-3">
                    CAPABILITY
                  </th>
                  <th className="bg-[#0b0f1a] text-white text-xs font-semibold tracking-wide uppercase px-4 py-3">
                    MANUAL + CHATGPT
              ...
              <tbody>
                {[
                  [
                    "Amazon.in Native Reviews",
                    "Manual export",
                    "Partial — US-primary",
                    "Native Amazon.in",
                  ],
                  [
                    "Flipkart Review Tracking",
                    "Manual only",
                    "Not supported",
                    "Full coverage",
                  ],
                  ...
                  [
                    "RTO Trigger Detection",
                    "Not possible",
                    "Not built for it",
                    "India-calibrated AI",
                  ],
                  [
                    "WhatsApp Sentiment Alerts",
                    "None",
                    "Email only",
                    "Within 60 min",
                  ],
                  [
                    "Festive Review Intelligence",
                    "Manual",
                    "Not available",
                    "BBD, GIF, Diwali tuned",
                  ],
                  [
                    "AI Listing Recommendations",
                    "Manual rewrite",
                    "Generic copy",
                    "Per-ASIN, per-cluster",
                  ],
                  [
                    "Pricing",
                    "Your time + ChatGPT",
          ...
          <div className="space-y-4 my-8">
            {[
              {
                emoji: "🔍",
                title: "Full Amazon.in + Flipkart review database",
                desc: "Reviews tracked natively on both platforms — not estimated from Amazon.com. Flipkart review coverage is unique to India-first tools.",
              },
              {
                emoji: "💭",
                title: "Hindi & Hinglish sentiment classification",
                desc: 'Regional language reviews, transliterated Hindi complaints, and Hinglish product feedback are clustered correctly — not filtered out as "low confidence" like US-trained models do.',
              },
              {
                emoji: "🚚",
                title: "RTO trigger theme detection",
                desc: '"Wrong size," "different from photo," "packaging damaged," "COD courier rude" — the four highest-converting RTO drivers are detected and scored automatically per ASIN.',
              },
              {
                emoji: "📱",
                title: "WhatsApp sentiment alerts within 60 minutes",
                desc: "Any negative theme spike on a tracked ASIN — yours or a competitor's — triggers a WhatsApp alert with the cluster name, sample reviews, and a recommended listing fix.",
              },
              {
                emoji: "🤖",
                title: "AI listing recommendations",
                desc: "For each top sentiment cluster, the platform generates the exact bullet point or A+ copy edit to test — no guesswork, no duplication.",
              },
              {
                emoji: "🪔",
                title: "Festive-tuned review intelligence",
                desc: "Pre-festive review audits surface seasonal complaint themes specific to Big Billion Days, Great Indian Festival, Diwali, and Republic Day Sale — three weeks before the revenue window opens.",
              },
            ].map((f, i) => (
              <div
                key={i}
                className="p-5 rounded-xl bg-[#F5F3FF] dark:bg-purple-900/20 flex gap-4 items-start"
              >
                <span className="text-xl mt-0.5">{f.emoji}</span>
                <div>
                  <h4
                    className="font-bold text-slate-900 dark:text-white text-[15px] mb-1.5"
                    style={{ fontFamily: "'Sora', sans-serif" }}
                  >
                    {f.title}
                  </h4>
          ...
          <div className="box box-red">
            ...
            <p className="text-[15px] leading-relaxed text-slate-800 dark:text-slate-200">
              If you're an Indian D2C seller on Amazon.in or Flipkart and you're
              still reading reviews manually — or running them through ChatGPT
              one CSV at a time — you're optimising on guesswork. The question
              isn't whether you need a review analysis tool — it's which one is
              built for your market and your budget. For most Indian D2C
              sellers, the answer is clearly an India-first platform.
            </p>
          </div>

          <h2 id="faq" className="mt-16 mb-6">
          ...
          <div className="space-y-4 mb-10">
            {[
              ...
              <details
                key={i}
                className="group border border-slate-200 dark:border-slate-800 rounded-xl bg-white dark:bg-slate-900 overflow-hidden [&_summary::-webkit-details-marker]:hidden"
              >
                <summary className="flex items-center justify-between cursor-pointer p-5 font-semibold text-slate-900 dark:text-white transition-colors hover:bg-slate-50 dark:hover:bg-slate-800/50">
                  ...
                  <span className="transition group-open:rotate-45 text-purple-600 font-light text-2xl leading-none">
                    +
                  </span>
                </summary>
      ...
      <section className="py-20 bg-blue-600 text-center relative overflow-hidden">
        <div className="max-w-4xl mx-auto px-4 relative z-10 text-center">
          <h2 className="text-3xl md:text-5xl font-black text-white mb-6 font-['Sora'] leading-tight">
            Winning on Amazon India and Flipkart in 2026 Isn't About Having the
            Best Product.
          </h2>
          <p className="text-blue-50 font-['Lora'] text-lg md:text-xl max-w-3xl mx-auto mb-10 leading-relaxed">
            It's about being the brand whose reviews tell the right story — and
            whose listings answer the complaints buried in your competitors'.
            Insydz delivers AI review intelligence built for Indian marketplace
            sellers, with Hinglish NLP and Flipkart coverage no global tool
            provides.
          </p>
          ...
          <p className="text-blue-200 text-sm font-['Lora']">
            No setup required · Amazon India, Flipkart supported · No credit
            card needed
          </p>
        </div>
      </section>
