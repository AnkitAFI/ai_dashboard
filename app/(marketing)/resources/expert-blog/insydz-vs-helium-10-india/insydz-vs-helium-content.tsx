...
export default function InsydzVsHelium10India() {
  ...
  useEffect(() => {
    ...
    return () => {
      SCHEMAS.forEach((_, i) => { document.getElementById(`insydz-blog5-schema-${i}`)?.remove(); });
    };
  }, []);
  ...
  const compRows: { feature: string; insydz: string; h10: string }[] = [
    ...
    { feature: "Starter Plan Price",        insydz: "₹1,999/month",                         h10: "₹3,300/month" },
  ...
  const pricingRows: { tier: string; insydz: string; h10: string; diff: string; highlight: boolean }[] = [
    { tier: "Entry / Free",           insydz: "₹0 (forever free)",  h10: "₹0 (30-day trial)", diff: "Insydz: no time limit",   highlight: false },
    { tier: "Starter",                insydz: "₹1,999/month",         h10: "₹3,300/month",       diff: "Insydz: 85% cheaper",    highlight: false },
    ...
    <div className="min-h-screen bg-white dark:bg-gray-950 transition-colors">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            ...
            <div className="flex lg:hidden items-center gap-2">
              <button className="p-1.5 rounded-full bg-gray-200 dark:bg-gray-700" onClick={() => setIsDarkMode(!isDarkMode)}>
        ...
        {isMenuOpen && (
          <div className="lg:hidden bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800 max-h-[calc(100vh-5rem)] overflow-y-auto">
            <div className="px-4 py-4 space-y-2">
              ...
              <button onClick={() => { router.push("/pricing"); setIsMenuOpen(false); }} className="block w-full text-left px-4 py-2 text-gray-700 dark:text-gray-300 hover:bg-purple-50 rounded-lg font-medium">Pricing</button>
      ...
      <div style={{ background: "#F8FAFC", borderBottom: "1px solid #E2E8F0", padding: "10px 0", marginTop: 80 }}>
        <div style={{ maxWidth: 1240, margin: "0 auto", padding: "0 24px", display: "flex", alignItems: "center", gap: 6, fontSize: 12.5, color: "#94A3B8", flexWrap: "wrap" as const }}>
          <button onClick={() => router.push("/")} style={{ color: "#64748B", fontWeight: 500, background: "none", border: "none", cursor: "pointer" }}>Home</button>
          <span>›</span>
          <button onClick={() => router.push("/resources/expert-blog")} style={{ color: "#64748B", fontWeight: 500, background: "none", border: "none", cursor: "pointer" }}>Blog</button>
          <span>›</span>
      ...
      <div style={{ maxWidth: 1240, margin: "0 auto", padding: "48px 24px 0" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", flexWrap: "wrap" as const, gap: "5px 18px", marginBottom: 28 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 6, fontSize: 13, color: "#64748B" }}><Users className="w-3.5 h-3.5" /><strong className="text-[#0D1B2A] hover:text-orange-500 transition-colors cursor-pointer" onClick={() => router.push("/author/vikrant-singh")}>Vikrant Singh</strong></div>
        ...
        <div className="stat-strip" style={{ marginBottom: 32 }}>
          {([ ["1.7M+", "Active Sellers on Amazon.in + Flipkart Combined"], ["60–85%", "Cost Savings with Insydz vs Helium 10"], ["30–50%", "More India-Relevant Keywords Surfaced by Insydz"], ["₹60,012", "Saved Per Year on Growth Plan vs Helium 10 Platinum"] ] as [string, string][]).map(([num, lbl]) => (
      ...
      <div className="article-layout">
        ...
        <aside className="toc-sidebar">
          ...
          <div style={{ background: "linear-gradient(160deg,#0D1B2A 0%,#162B45 100%)", borderRadius: 10, padding: 24, marginTop: 20 }}>
            <h4 style={{ fontFamily: "'Sora',sans-serif", fontSize: 16, fontWeight: 800, color: "white", marginBottom: 10, lineHeight: 1.35, letterSpacing: "-.2px" }}>India's #1 Alternative to Helium 10</h4>
            <p style={{ fontSize: 12.5, color: "#94A3B8", marginBottom: 16, lineHeight: 1.6, fontFamily: "'Sora',sans-serif" }}>Built for Amazon.in, Flipkart &amp;. WhatsApp alerts. Hinglish keywords. ₹1,999/mo.</p>
            <ul style={{ listStyle: "none", padding: 0, margin: "0 0 18px" }}>
              {["Amazon.in + Flipkart coverage", "Hinglish keyword database — India-native", "WhatsApp alerts in under 60 minutes", "From ₹1,999/mo — or free forever"].map(f => (
            ...
            <button onClick={() => router.push("/login")} style={{ display: "block", background: "#F97316", color: "white", textAlign: "center" as const, padding: 12, borderRadius: 8, fontWeight: 700, fontSize: 13.5, width: "100%", cursor: "pointer", border: "none", fontFamily: "'Sora',sans-serif" }}>
          ...
          <article className="article-body">
            ...
            <div style={{ display: "flex", flexDirection: "column" as const, gap: 12, margin: "20px 0 28px" }}>
              {[
                ...
                {
                  n: 3, color: "#DB2777", title: "Budget Gap",
                  body: (
                    <span>
            ...
            <div className="mistakes">
              {[
                ...
                {
                  n: 3, t: "WhatsApp vs Email — The Action Rate Gap",
                  b: <span>
                    Helium 10 alerts are email-based. The average Indian SMB seller checks email 2–3 times a day. They check WhatsApp 50+ times. A competitor price drop alert via email at 4 PM may not be acted on until 9 AM the next day.{" "}
                    {/* #36 — "Buy Box has been lost for 17 hours" → /resources/expert-blog/amazon-competitor-price-tracking-tool */}
                    By then, the <InLink to="/resources/expert-blog/amazon-competitor-price-tracking-tool" color="#64748b">Buy Box has been lost for 17 hours</InLink>.
                  </span>,
                },
                {
                  n: 4, t: "Pricing in Dollar Terms, Budget in Rupee Terms",
                  b: <span>
            ...
            <p>
              Insydz wasn't built by adapting a US tool for the Indian market. It was built ground-up with three premises: Indian sellers sell on Amazon.in, Flipkart simultaneously; Indian buyers search in Hinglish; and{" "}
            ...
            <h2 id="pricing">
              ...
              <InLink to="/pricing" color="#0d1b2a">Pricing Comparison: The Real Cost of Each Tool for Indian Sellers</InLink>
            </h2>

            <ArticleImg src="/sixteen.png" alt="Insydz vs Helium 10 pricing comparison in Indian Rupees" caption="Annual cost comparison: Insydz Growth vs Helium 10 Platinum — ₹60,012 difference per year" />
                  ...
                  {pricingRows.map((row, i) => (
                    <tr key={i} className={row.highlight ? "hl" : ""}>
                      ...
                      <td style={{ color: "#16A34A", fontWeight: 700 }}>
                        ...
                        {row.tier === "Starter"
                          ? <InLink to="/pricing" color="#16a34a">{row.insydz}</InLink>
                          : row.insydz}
                      </td>
                      <td>{row.h10}</td>
                      <td>
                        ...
                        {row.highlight
                          ? <InLink to="/pricing" color="#f97316"><span className="bg">{row.diff}</span></InLink>
            ...
            <p>
              ...
              {/* #6 alt — pricing link */}
              <InLink to="/pricing" color="#db2777">₹6,500/month Helium 10 Platinum plan</InLink>{" "}
            ...
            <div className="mistakes">
              {[
                ...
                {
                  n: 3, t: "Ignoring the Flipkart Revenue Stream When Calculating ROI",
                  b: <span>Indian sellers often evaluate tools exclusively in the context of their Amazon business. But Flipkart typically contributes 25–50% of a multi-platform seller's total revenue. A tool that delivers zero Flipkart intelligence is only serving half your business.</span>,
                },
                {
                  n: 4, t: "Underestimating the Cost of Slow Alerts",
                  b: <span>
                    The difference between an email alert and a WhatsApp alert isn't just convenience — it's response time with direct revenue value. A Buy Box loss on a product doing ₹2,000/day costs approximately ₹1,400–1,600 for every 8-hour delay. A tool that costs ₹3,000 less per month but results in 4-hour slower alerts may not actually be cheaper.
                  </span>,
                },
                {
                  n: 5, t: "Treating the Decision as Permanent",
                  b: <span>
            ...
            <div className="mid-cta">
              ...
              <button onClick={() => router.push("/login")} style={{ flexShrink: 0, background: "#F97316", color: "white", padding: "12px 26px", borderRadius: 8, fontWeight: 700, fontSize: 14.5, whiteSpace: "nowrap" as const, cursor: "pointer", border: "none", fontFamily: "'Sora',sans-serif" }}>Try Insydz Free →</button>
            </div>
              ...
              <div className="choose-card" style={{ background: "#F1F5F9", border: "1px solid #CBD5E1" }}>
                ...
                <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column" as const, gap: 6 }}>
                  {[
                    ...
                    <li key={item} style={{ fontFamily: "'Sora',sans-serif", fontSize: 13.5, lineHeight: 1.6, marginBottom: 0, color: "#374151", display: "flex", alignItems: "flex-start", gap: 7, listStyle: "none" }}>
                      <span style={{ color: "#6B7280", fontWeight: 800, fontSize: 12, flexShrink: 0, marginTop: 2 }}>→</span>{item}
                    </li>
                  ))}
                </ul>
              </div>
              <div className="choose-card" style={{ background: "#F0FDF4", border: "2px solid #86EFAC" }}>
                ...
                <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column" as const, gap: 6 }}>
                  {[
                    ...
                    <li key={item} style={{ fontFamily: "'Sora',sans-serif", fontSize: 13.5, lineHeight: 1.6, marginBottom: 0, color: "#374151", display: "flex", alignItems: "flex-start", gap: 7 }}>
                      <span style={{ color: "#16A34A", fontWeight: 800, fontSize: 12, flexShrink: 0, marginTop: 2 }}>✓</span>{item}
                    </li>
                  ))}
                </ul>
              </div>
              ...
              {[
                ...
                <div key={si} style={{ background: "#F8FAFC", border: "1px solid #E2E8F0", borderRadius: 10, padding: "18px 20px" }}>
                  <div style={{ fontFamily: "'Sora',sans-serif", fontSize: 13.5, fontWeight: 700, color: "#0D1B2A", marginBottom: 10, display: "flex", alignItems: "center", gap: 8 }}>
                    ...
                    {section.phaseLink
                      ? <InLink to={section.phaseLink} color="#0d1b2a">{section.phase}</InLink>
                      : section.phase}
                  </div>
            ...
            <div style={{ marginTop: 20 }}>
                ...
                {openFaq === 0 && (
                  <div className="faq-a">
                    <p>
                      ...
                      <InLink to="/pricing" color="#64748b">India-first alternatives exist at ₹1,999–2,999/month</InLink>.
                    </p>
                  </div>
                )}
              </div>
              ...
              <div className={`faq-item${openFaq === 2 ? " open" : ""}`}>
                <div className="faq-q" onClick={() => setOpenFaq(openFaq === 2 ? null : 2)}>
                  ...
                  <InLink to="/compare/insydzvshelium" color="#0d1b2a">What is the best Helium 10 alternative for Indian sellers?</InLink>
                ...
                {openFaq === 2 && (
                  <div className="faq-a">
                    <p>
                      ...
                      that Indian SMBs can justify. Insydz is currently the only platform that meets all four of these criteria simultaneously — with a{" "}
                      {/* #28 — "no-time-limit free plan" → /pricing */}
                      <InLink to="/pricing" color="#64748b">no-time-limit free plan</InLink>{" "}
                      for sellers who want to experience the value before committing.
                    </p>
                  </div>
                )}
              </div>
              ...
              <div className={`faq-item${openFaq === 4 ? " open" : ""}`}>
                <div className="faq-q" onClick={() => setOpenFaq(openFaq === 4 ? null : 4)}>
                  How does Insydz compare to Helium 10 for keyword research on Amazon.in?
              ...
              <div className={`faq-item${openFaq === 5 ? " open" : ""}`}>
                <div className="faq-q" onClick={() => setOpenFaq(openFaq === 5 ? null : 5)}>
                ...
                {openFaq === 5 && (
                  <div className="faq-a">
                    <p>
                      ...
                      <InLink to="/pricing" color="#64748b">no-time-limit free plan</InLink>{" "}
                      allows a more thorough evaluation without the clock pressure of a 30-day window.
                    </p>
                  </div>
                )}
              </div>
            ...
            <div style={{ marginTop: 56, paddingTop: 36, borderTop: "2px solid #E2E8F0" }}>
              ...
              <div className="related-grid">
                {([
                  ...
                  <div key={rc.cardTitle} className="rel-card" onClick={() => router.push(rc.r)}>
