...
const schemaAmazonZeroReferralFee = {
  ...
  "@graph": [
    {
      "@type": "WebPage",
      "@id": "https://insydz.com/resources/expert-blog/amazon-zero-referral-fee",
      ...
      "breadcrumb": {
        "@id": "https://insydz.com/blog/amazon-zero-referral-fee-undercutting-india-2026#breadcrumb"
      }
    },
    {
      "@type": "BreadcrumbList",
    ...
    {
      "@type": "BlogPosting",
      "@id": "https://insydz.com/blog/amazon-zero-referral-fee-undercutting-india-2026#article",
      "headline": "Amazon Zero Referral Fee Undercutting India 2026: How to Rebuild Your Pricing Strategy and Keep More Profit",
      "description": "Amazon India waived referral fee on products priced up to Rs 999 across 1800+ categories, effective 16 March 2026. Sellers who have not repriced against this are leaving margin on the table. Verify exact wording, date, and category count against the live page.",
      ...
      "mainEntityOfPage": {
        "@id": "https://insydz.com/blog/amazon-zero-referral-fee-undercutting-india-2026"
      },
      "keywords": [
      ...
      "articleSection": "Fee Changes, Pricing Intelligence (low confidence) on page, confirm",
      "inLanguage": "en"
    },
    {
      "@type": "FAQPage",
      "@id": "https://insydz.com/blog/amazon-zero-referral-fee-undercutting-india-2026#faq",
      "mainEntity": [
        {
          "@type": "Question",
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify(schemaAmazonZeroReferralFee) }}
      />
