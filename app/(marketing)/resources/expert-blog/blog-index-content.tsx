...
const articles: Article[] = [
  ...
  },
  {
    ...
    readTime: "12 min read",
    image: "/analyze-amazon-reviews-opportunities.png",
...
export default function ExpertBlog() {
  ...
  const [selectedCategory, setSelectedCategory] =
    useState<BlogCategory>("All Articles");
  ...
  const latestArticles = filteredArticles.slice(
    startIndex,
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400 mb-6 leading-relaxed max-w-3xl mx-auto">
              Actionable strategies, data-backed guides, and marketplace
              insights for Amazon and Flipkart sellers in India.
            </p>
      ...
      <section
        id="latest-insights-section"
        className="py-10 bg-gradient-to-br from-orange-50 to-red-50 dark:from-gray-900 dark:to-gray-800"
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-3 mb-8">
            <div className="w-1 h-8 bg-gradient-to-b from-orange-500 to-red-500 rounded-full"></div>
            ...
            <div className="flex items-center justify-center gap-2 mt-12">
              ...
              {getPageNumbers().map((page, idx) =>
                page === "..." ? (
                  <span
                    key={`ellipsis-${idx}`}
                    className="w-10 h-10 flex items-center justify-center text-gray-400 dark:text-gray-500 text-sm font-medium"
                  >
                    …
                  </span>
                ) : (
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
                Jump straight to the insights you need for your specific
                challenge
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {problemBlocks.map((block, index) => (
                ...
                >
                  <div
                    className={`w-14 h-14 bg-gradient-to-br ${block.color} rounded-xl flex items-center justify-center mb-6 text-white group-hover:scale-110 transition-transform shadow-lg`}
                  >
                    {block.icon}
                  </div>
      ...
      >
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <h2
            className="text-3xl md:text-5xl font-extrabold mb-6 text-white tracking-tight"
          ...
          <p
            className="text-lg md:text-xl text-blue-50 mb-10 leading-relaxed max-w-2xl mx-auto"
            style={{ fontFamily: "'Lora', serif" }}
          >
            Every strategy you read here can be tested inside Insydz using your
            real product data. Connect your marketplace today.
          </p>
          ...
          >
            {["Free forever plan", "No credit card", "Results in 5 min"].map(
              (t) => (
                <div
                  key={t}
                ...
                >
                  <span className="bg-background opacity-100 p-1 rounded-full">
          ...
          <p
            className="text-sm text-blue-200 mt-6 font-medium"
            style={{ fontFamily: "'Sora', sans-serif" }}
          >
