      ...
      <div className="article-layout">
        ...
        <aside className="toc-sidebar">
          ...
          <div style={{ background:"linear-gradient(160deg,#0D1B2A 0%,#162B45 100%)", borderRadius:10, padding:18, marginTop:16 }}>
            ...
            <button onClick={() => router.push("/login")} style={{ display:"block", background:"#7C3AED", color:"white", textAlign:"center" as const, padding:10, borderRadius:8, fontWeight:700, fontSize:12.5, width:"100%", cursor:"pointer", border:"none", fontFamily:"'Sora',sans-serif" }}>
        ...
        <main style={{ minWidth:0 }}>
          ...
          <article className="article-body">
            ...
            <div className="mid-cta">
              ...
              <button onClick={() => router.push("/login")} style={{ flexShrink:0, background:"#7C3AED", color:"white", padding:"11px 22px", borderRadius:8, fontWeight:700, fontSize:"clamp(13px,2vw,14.5px)", whiteSpace:"nowrap" as const, cursor:"pointer", border:"none", fontFamily:"'Sora',sans-serif", width:"100%" }} className="sm:w-auto">Try Insydz Free →</button>
            </div>
            ...
            <div style={{ marginTop:48, paddingTop:28, borderTop:"2px solid #E2E8F0" }}>
              ...
              <div className="related-grid">
                {[
                  { t:"Best Review Analysis Tools for Indian Sellers: Complete Guide 2026",              tag:"Review Intelligence", imgSrc:"/eighteen.png", r:"/resources/expert-blog/best-review-analysis-tool-india" },
                  ...
                  { t:"Best Competitor Price Tracking Tools for Indian Sellers: The 2026 Guide",        tag:"Price Tracking",      imgSrc:"/one.png", r:"/features/competitor-price-tracking-feature" },
                ].map(rc => (
