...
export default function AmazonReviewAnalysisToolIndia() {
  ...
  const compRows = [
    ...
    { cap:"Pricing",                   manual:"Your time (4–6 hrs/wk)", global:"₹3,300–8,300/month", insydz:"₹1,999–2,999/mo (free tier)" },
  ];
  ...
  const toolRows = [
    ...
    { tool:"Insydz",                    review:"AI-powered",    platforms:"Amazon.in + Flipkart", hinglish:"Yes", wa:"Yes", price:"₹1,999–2,999" },
  ];
    ...
    <div className="min-h-screen bg-white dark:bg-gray-950 transition-colors">
      ...
      <div className="breadcrumb" style={{ marginTop:64 }}>
        <div className="breadcrumb-inner">
          ...
          <span>›</span>
          <span style={{ color:"#94A3B8" }}>Amazon Review Analysis Tool India</span>
        </div>
      </div>
      ...
      <div className="article-hero">
        ...
        <div style={{ display:"flex", alignItems:"center", flexWrap:"wrap" as const, gap:"4px 14px", marginBottom:20 }}>
          ...
          <span style={{ background:"#F0FDF4", color:"#16A34A", fontSize:"clamp(9px,2vw,11px)", fontWeight:700, padding:"2px 7px", borderRadius:4 }}>BOFU Guide</span>
        </div>
      ...
      <div className="article-layout">
        ...
        <aside className="toc-sidebar">
          ...
          <div style={{ background:"linear-gradient(160deg,#0D1B2A 0%,#162B45 100%)", borderRadius:10, padding:18, marginTop:16 }}>
            <h4 className="sidebar-cta-title">Mine Reviews Like a Pro — Free</h4>
            <p className="sidebar-cta-body">AI-powered review intelligence for Amazon.in, Flipkart &amp;. Hindi + Hinglish + English.</p>
            ...
            <button onClick={() => router.push("/login")} style={{ display:"block", background:"#16A34A", color:"white", textAlign:"center" as const, padding:10, borderRadius:8, fontWeight:700, fontSize:12.5, width:"100%", cursor:"pointer", border:"none", fontFamily:"'Sora',sans-serif" }}>
        ...
        <main style={{ minWidth:0 }}>
          ...
          <article className="article-body">
            ...
            <div className="steps">
              {[
                { n:1, t:"Ingest & Language Detection",       d:"Reviews are pulled from Amazon.in, Flipkart listings — yours and your competitors'. Each review is language-detected and processed natively in Hindi, Hinglish, or English. No forced translation that loses meaning before analysis begins." },
                { n:2, t:"Sentiment Classification",           d:"Each review is scored positive, neutral, or negative — with sub-sentiment tags like 'delivery complaint', 'feature praise', 'value-for-money concern', and 'return intent'. The scoring model is calibrated for Indian marketplace language, not Western retail vocabulary." },
            ...
            <div className="mistakes">
              {[
                { n:1, t:"Using Star Rating as a Proxy for Product Health",
                ...
                { n:2, t:"Only Reading Your Own Reviews and Ignoring Competitors'",
                ...
                { n:3, t:"Reacting to Individual Reviews Instead of Patterns",
                ...
                { n:4, t:"Not Connecting Review Intelligence to Listing Copy",
                ...
                { n:5, t:"Treating Review Analysis as a One-Time Audit",
            ...
            <div className="mid-cta">
              <div>
                ...
                <p>AI review intelligence for Amazon.in, Flipkart &amp;. WhatsApp alerts. Hinglish-ready. Setup in under 30 minutes.</p>
              </div>
              <button onClick={() => router.push("/login")} style={{ flexShrink:0, background:"#16A34A", color:"white", padding:"11px 22px", borderRadius:8, fontWeight:700, fontSize:"clamp(13px,2vw,14.5px)", whiteSpace:"nowrap" as const, cursor:"pointer", border:"none", fontFamily:"'Sora',sans-serif", width:"100%" }} className="sm:w-auto">Try Insydz Free →</button>
            </div>
            ...
            <div style={{ marginTop:48, paddingTop:28, borderTop:"2px solid #E2E8F0" }}>
              ...
              <div className="related-grid">
                {[
                  ...
                  <div key={rc.t} className="rel-card" onClick={() => router.push(rc.r)}>
