        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-5 lg:px-8">
          <div className="flex items-center justify-between h-[72px] lg:h-20">
            ...
            >
              ...
              <span className="text-lg lg:text-xl font-bold bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent ml-1.5">
                Insydz
              </span>
            </div>
              ...
              {(
                ...
                <div key={label}>
                  <button
                    ...
                    className={`flex items-center justify-between w-full px-4 py-3 rounded-lg font-medium text-sm ${accent === "orange" ? "text-orange-600 dark:text-orange-500 hover:bg-orange-50" : "text-gray-700 dark:text-gray-300 hover:bg-purple-50 dark:hover:bg-purple-900/20"}`}
                  >
                    {label}
                    <ChevronDown
                    ...
                    <div className="ml-4 mt-1 space-y-0.5 pb-1">
                      {navigationMenu[key].map((item, i) => (
                        <button
                          key={i}
                          onClick={() => handleMenuItemClick(item)}
                          className={`flex items-center gap-2 w-full px-4 py-2.5 text-sm rounded-lg ${accent === "orange" ? "text-gray-600 hover:bg-orange-50" : "text-gray-600 dark:text-gray-400 hover:bg-purple-50 dark:hover:bg-purple-900/20"}`}
                        >
          ...
          <article className="article-body">
            ...
            >
              ...
              <div className="related-grid">
                {[
                  {
                    t: "Amazon Competitor Price Tracking Tool India: Complete Guide (2026)",
                    tag: "Price Tracking",
                    imgSrc: "/one.png",
                    r: "/features/competitor-price-tracking-feature",
                  },
                  {
                    t: "Flipkart Price Tracker: Monitor & Beat Competitor Prices in 2026",
                    tag: "Flipkart Sellers",
                    imgSrc: "/01_hero_banner.png",
                    r: "/solutions/flipkart-sellers",
                  },
                  {
                    t: "How to Win the Amazon Buy Box Consistently as an Indian Seller",
                    tag: "Buy Box Strategy",
                    imgSrc: "/three.png",
                    r: "/use-cases/track-competitor-prices",
                  },
                ].map((rc) => (
                  <div
                    key={rc.t}
