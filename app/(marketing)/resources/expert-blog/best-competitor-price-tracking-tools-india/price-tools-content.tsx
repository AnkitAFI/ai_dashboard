    ...
    <div className="min-h-screen bg-white dark:bg-gray-950 transition-colors">
      ...
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? "bg-background opacity-100 dark:bg-gray-900/95 backdrop-blur-none shadow-lg" : "bg-background dark:bg-gray-900/80 backdrop-blur-none"}`}>
        <div className="max-w-7xl mx-auto px-3 sm:px-5 lg:px-8">
          <div className="flex items-center justify-between h-[72px] lg:h-20">
            ...
            {/* Logo */}
            <div className="flex items-center space-x-1 group cursor-pointer flex-shrink-0" onClick={() => router.push("/")}>
              <div className="relative">
            ...
            <div className="hidden lg:flex items-center space-x-0.5 xl:space-x-1" ref={dropdownRef}>
              ...
              <button onClick={() => router.push("/pricing")} onMouseEnter={() => setActiveDropdown(null)} className="px-2 xl:px-3 py-2 text-sm text-gray-700 dark:text-gray-300 hover:text-purple-600 font-medium rounded-lg hover:bg-purple-50 dark:hover:bg-purple-900/20 transition-all">Pricing</button>
        ...
        {isMenuOpen && (
          <div className="lg:hidden bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800 max-h-[calc(100dvh-72px)] overflow-y-auto">
            <div className="px-4 py-3 space-y-1">
              <button onClick={() => { router.push("/resources/expert-blog"); setIsMenuOpen(false); }} className="flex items-center gap-2 w-full px-4 py-3 text-gray-700 dark:text-gray-300 hover:bg-purple-50 dark:hover:bg-purple-900/20 rounded-lg font-medium text-sm">
              ...
              <button onClick={() => { router.push("/pricing"); setIsMenuOpen(false); }} className="block w-full text-left px-4 py-3 text-gray-700 dark:text-gray-300 hover:bg-purple-50 dark:hover:bg-purple-900/20 rounded-lg font-medium text-sm">Pricing</button>
              <div className="pt-2">
                <Button onClick={() => { router.push("/login"); setIsMenuOpen(false); }} className="w-full bg-gradient-to-r from-pink-500 to-rose-500 text-white font-semibold py-3 rounded-xl">Login</Button>
              </div>
            </div>
          </div>
        )}
      ...
      <div className="breadcrumb-bar">
        <div className="breadcrumb-inner">
          <button className="breadcrumb-btn" onClick={() => router.push("/")}>Home</button>
          <span style={{ color: "#E2E8F0" }}>›</span>
          <button className="breadcrumb-btn" onClick={() => router.push("/resources/expert-blog")}>Blog</button>
          <span style={{ color: "#E2E8F0" }}>›</span>
      ...
      <div className="hero-section">
        ...
        <div style={{ display: "flex", alignItems: "center", flexWrap: "wrap", gap: "5px 16px", marginBottom: 24 }}>
          {[
            <><Users className="w-3.5 h-3.5 inline mr-1 text-gray-400" /><strong className="text-[#0D1B2A] hover:text-orange-500 transition-colors cursor-pointer" onClick={() => router.push("/author/vikrant-singh")}>Vikrant Singh</strong></>,
      ...
      <div className="article-layout">
        ...
        <aside className="toc-sidebar" aria-label="Table of contents">
          ...
          <div className="sidebar-cta">
            ...
            <button onClick={() => router.push("/login")} style={{ display: "block", background: "#F97316", color: "white", textAlign: "center", padding: "11px 0", borderRadius: 8, fontWeight: 700, fontSize: 13.5, width: "100%", cursor: "pointer", border: "none", fontFamily: "'Sora',sans-serif", minHeight: 44 }}>
        ...
        <main>
          ...
          <article className="article-body">
            ...
            <div className="mid-cta">
              ...
              <button className="mid-cta-btn" onClick={() => router.push("/login")}>Try Insydz Free →</button>
            </div>
