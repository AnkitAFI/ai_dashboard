...
function FloatingBadge({
  ...
  return (
    <div
      className={`flex items-center gap-3 rounded-2xl p-4 shadow-[0_18px_36px_rgba(40,20,90,0.12)] ${
        dark ? "bg-[#1a1033]" : "bg-white"
      }`}
    ...
    >
      ...
      <span className="flex flex-col gap-0.5">
        <span className={`text-[15px] font-extrabold ${dark ? "text-white" : "text-[#1a1033]"}`}>
          {title}
        </span>
...
function Eyebrow({ children }: { children: React.ReactNode }) {
  return (
    <span className="text-[13px] font-extrabold tracking-[0.1em] text-violet-600">
      {children}
    </span>
  );
}
...
function SecondaryButton({
  ...
  const cls = `inline-flex items-center justify-center gap-2 rounded-full border-[1.5px] border-[#d9cff0] bg-white px-7 py-[15px] text-[15px] font-bold text-[#1a1033] transition-colors hover:bg-[#faf8fe] ${className}`;
  if (href) {
    return (
      <Link href={href} className={cls}>
        {children}
...
export default function LandingContent() {
  ...
  const [activeFeatureTab, setActiveFeatureTab] = useState(featureTabs[1].key);
  const activeTab = featureTabs.find((t) => t.key === activeFeatureTab) ?? featureTabs[1];
  ...
  return (
    <div
      className="min-h-screen bg-white text-[#1a1033] overflow-x-clip"
      style={{ fontFamily: FONT_STACK }}
    >
      {/* Hero Section */}
      <section
        id="Home"
        className="relative overflow-hidden bg-[#fcfaff] pt-28 pb-16 lg:pt-32 lg:pb-20 scroll-mt-20"
      >
        {/* Decorative concentric circles */}
        <div className="pointer-events-none absolute left-1/2 top-[420px] hidden -translate-x-1/2 lg:block">
          <div className="h-[560px] w-[560px] rounded-full border border-[#ece4fb]" />
        </div>
        <div className="pointer-events-none absolute left-1/2 top-[470px] hidden -translate-x-[46%] lg:block">
          <div className="h-[380px] w-[380px] rounded-full border border-[#e4d8fa] bg-[#f6f1ff]" />
        </div>
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col items-center gap-6 text-center">
            <Link
              href="/login"
              className="mx-auto inline-flex max-w-full flex-wrap items-center justify-center gap-2 rounded-full border border-[#e4dcf5] bg-white py-1.5 pl-1.5 pr-4 text-xs font-semibold text-[#3b3552] shadow-[0_4px_14px_rgba(76,29,149,0.06)] sm:gap-3 sm:text-sm"
            >
            ...
            <h1 className="max-w-3xl text-4xl font-extrabold leading-[1.1] tracking-[-0.03em] text-[#1a1033] sm:text-5xl lg:text-[56px]">
              One platform to{" "}
              ...
              on{" "}
              <span className="inline-block -rotate-2 rounded-2xl bg-[#fff1e0] px-3 py-1 text-[#9a3412]">
                Amazon
              </span>{" "}
              and{" "}
              <span className="inline-block rotate-2 rounded-2xl bg-[#e3edff] px-3 py-1 text-[#1e40af]">
                Flipkart
              </span>
            </h1>

            <p className="max-w-xl text-lg leading-relaxed text-[#4b4560]">
            ...
            <div className="flex flex-col items-center gap-4 pt-2 sm:flex-row">
              ...
              <Link
                href="/login"
                className="text-[15px] font-bold text-[#1a1033] underline decoration-[#d9cff0] decoration-2 underline-offset-4 sm:hidden"
              >
                Log in
              </Link>
            </div>

            <p className="text-sm font-semibold text-[#4b4560]">
              ⚡ Get instant WhatsApp alerts for price drops, Buy Box losses &amp; keyword rank changes
            </p>

            <div className="flex flex-wrap items-center justify-center gap-x-6 gap-y-2 pt-2 text-center text-sm font-semibold text-[#5f5875]">
              <span className="flex items-center gap-2">
                <span className="flex">
                  <span className="flex h-7 w-7 items-center justify-center rounded-full border-2 border-white bg-violet-100 text-[10px] font-extrabold text-violet-700">
                    RK
                  </span>
                  <span className="-ml-2 flex h-7 w-7 items-center justify-center rounded-full border-2 border-white bg-pink-100 text-[10px] font-extrabold text-pink-700">
                    AS
                  </span>
                  <span className="-ml-2 flex h-7 w-7 items-center justify-center rounded-full border-2 border-white bg-green-100 text-[10px] font-extrabold text-green-700">
                    PM
                  </span>
                </span>
                <span>
                  <strong className="text-[#1a1033]">5,000+</strong> sellers
                </span>
              </span>
              <span className="h-1 w-1 rounded-full bg-[#c9c2dd]" />
              <span>
                <strong className="text-[#1a1033]">2.5L+</strong> reviews analysed
              </span>
              <span className="h-1 w-1 rounded-full bg-[#c9c2dd]" />
          ...
          <div className="mx-auto mt-10 block max-w-md sm:mt-12 sm:max-w-xl lg:hidden">
            <div className="relative overflow-hidden rounded-[22px] border border-[#e9e3f5] bg-white shadow-[0_24px_50px_rgba(40,20,90,0.14)]">
              <div className="flex flex-wrap items-center justify-between gap-2 px-4 py-3.5 sm:px-6 sm:py-4">
                <span className="flex items-center gap-2 text-sm font-extrabold sm:text-base">
                  <BarChart3 className="h-4 w-4 text-violet-600 sm:h-5 sm:w-5" />
                  Overview
                </span>
                <span className="flex flex-wrap gap-1.5 sm:gap-2">
                  <span className="flex items-center gap-1.5 rounded-full bg-[#fff1e0] px-2.5 py-1 text-[10px] font-bold text-[#9a3412] sm:px-3 sm:py-1.5 sm:text-xs">
                    <span className="h-1.5 w-1.5 rounded-full bg-green-600" />
                    Amazon connected
                  </span>
                  <span className="flex items-center gap-1.5 rounded-full bg-[#e3edff] px-2.5 py-1 text-[10px] font-bold text-[#1e40af] sm:px-3 sm:py-1.5 sm:text-xs">
                    <span className="h-1.5 w-1.5 rounded-full bg-green-600" />
                    Flipkart data
                  </span>
                </span>
              ...
              <div className="grid grid-cols-3 gap-3 border-t border-[#f0ebf8] px-4 py-4 sm:px-6 sm:py-5">
                <div>
                  <div className="text-[11px] font-semibold text-[#5f5875] sm:text-xs">Total sales</div>
                  <div className="text-lg font-extrabold tracking-[-0.02em] sm:text-2xl">₹14.2L</div>
                  <div className="text-[11px] font-bold text-[#15803d] sm:text-xs">+18% this month</div>
                </div>
                <div>
                  <div className="text-[11px] font-semibold text-[#5f5875] sm:text-xs">Orders</div>
                  <div className="text-lg font-extrabold tracking-[-0.02em] sm:text-2xl">3,482</div>
                  <div className="text-[11px] font-bold text-[#15803d] sm:text-xs">+11%</div>
                </div>
                <div>
                  <div className="text-[11px] font-semibold text-[#5f5875] sm:text-xs">Ad ROAS</div>
                  <div className="text-lg font-extrabold tracking-[-0.02em] sm:text-2xl">4.6x</div>
                  <div className="text-[11px] font-bold text-[#15803d] sm:text-xs">+0.8x</div>
                </div>
              </div>
              ...
              <div className="border-t border-[#f0ebf8] p-4 sm:p-6">
                <div className="mb-3 flex flex-wrap items-center justify-between gap-2 sm:mb-4">
                  ...
                  <span className="flex gap-2.5 text-[11px] font-semibold text-[#5f5875] sm:gap-3 sm:text-xs">
          ...
          <div className="mx-auto mt-16 hidden max-w-6xl grid-cols-[1fr_1.9fr_1fr] items-center gap-6 lg:grid">
            ...
            <div className="relative z-10 overflow-hidden rounded-[28px] border border-[#e9e3f5] bg-white shadow-[0_40px_80px_rgba(40,20,90,0.18)]">
              <div className="flex items-center justify-between px-6 py-4">
                ...
                <span className="flex gap-2">
                  <span className="flex items-center gap-1.5 rounded-full bg-[#fff1e0] px-3 py-1.5 text-xs font-bold text-[#9a3412]">
                    <span className="h-1.5 w-1.5 rounded-full bg-green-600" />
                    Amazon connected
                  </span>
                  <span className="flex items-center gap-1.5 rounded-full bg-[#e3edff] px-3 py-1.5 text-xs font-bold text-[#1e40af]">
                    <span className="h-1.5 w-1.5 rounded-full bg-green-600" />
                    Flipkart data
                  </span>
                </span>
              ...
              <div className="grid grid-cols-3 gap-4 border-t border-[#f0ebf8] px-6 py-5">
                <div>
                  <div className="text-xs font-semibold text-[#5f5875]">Total sales</div>
                  <div className="text-2xl font-extrabold tracking-[-0.02em]">₹14.2L</div>
                  <div className="text-xs font-bold text-[#15803d]">+18% this month</div>
                </div>
                <div>
                  <div className="text-xs font-semibold text-[#5f5875]">Orders</div>
                  <div className="text-2xl font-extrabold tracking-[-0.02em]">3,482</div>
                  <div className="text-xs font-bold text-[#15803d]">+11%</div>
                </div>
                <div>
                  <div className="text-xs font-semibold text-[#5f5875]">Ad ROAS</div>
                  <div className="text-2xl font-extrabold tracking-[-0.02em]">4.6x</div>
                  <div className="text-xs font-bold text-[#15803d]">+0.8x</div>
                </div>
              </div>
              ...
              <div className="border-t border-[#f0ebf8] p-6">
                <div className="mb-4 flex items-center justify-between">
                  ...
                  <span className="flex gap-3 text-xs font-semibold text-[#5f5875]">
                    <span className="flex items-center gap-1.5">
                      <span className="h-2.5 w-2.5 rounded-[3px] bg-violet-600" />
                      Amazon
                    </span>
      ...
      {/* Trust bar */}
      <section className="border-y border-[#eee9f7] bg-white py-10">
        <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-8 px-4 sm:px-6 md:grid-cols-3 lg:px-8">
          <div className="flex flex-col gap-3">
            <span className="text-xs font-extrabold tracking-[0.08em] text-[#5f5875]">
              WORKS WITH
            </span>
            <div className="flex flex-wrap gap-2">
              <span className="rounded-full bg-[#fff1e0] px-3.5 py-2 text-sm font-bold text-[#9a3412]">
                Amazon India
              </span>
              <span className="rounded-full bg-[#e3edff] px-3.5 py-2 text-sm font-bold text-[#1e40af]">
                Flipkart
              </span>
              <span className="rounded-full bg-[#dcfce7] px-3.5 py-2 text-sm font-bold text-[#166534]">
                WhatsApp
              </span>
            </div>
          </div>
          <div className="flex justify-center gap-10">
            <div>
              ...
              <div className="text-[13px] font-semibold text-[#5f5875]">sellers trust Insydz</div>
            </div>
            <div>
              <div className="text-2xl font-extrabold tracking-[-0.02em]">2.5L+</div>
              <div className="text-[13px] font-semibold text-[#5f5875]">reviews analysed</div>
            </div>
            <div>
              <div className="text-2xl font-extrabold tracking-[-0.02em]">24/7</div>
              <div className="text-[13px] font-semibold text-[#5f5875]">live market data</div>
            </div>
          </div>
          <div className="flex items-start gap-3 rounded-2xl border border-green-200 bg-green-50 px-4 py-4">
            ...
            <span>
              ...
              <span className="text-[13px] leading-relaxed text-[#4b4560]">
      ...
      <section className="bg-white py-16 lg:py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto mb-14 flex max-w-2xl flex-col items-center gap-4 text-center">
            ...
            <p className="text-lg leading-relaxed text-[#4b4560]">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
            {[
              ...
              >
                ...
                <p className="text-[15px] leading-relaxed text-[#4b4560]">{s.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section id="Features" className="scroll-mt-20 bg-[#f6f1ff] py-16 lg:py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mx-auto mb-10 flex max-w-6xl items-center gap-1 overflow-x-auto rounded-full border border-[#e9e3f5] bg-white p-1.5">
            {featureTabs.map((t) => (
              <button
                key={t.key}
                onClick={() => setActiveFeatureTab(t.key)}
                className={`flex-1 whitespace-nowrap rounded-full px-3.5 py-2.5 text-[13px] font-bold transition-colors sm:text-sm ${
                  activeTab.key === t.key
                    ? "bg-[#1a1033] text-white"
                    : "text-[#3b3552] hover:bg-[#faf8fe]"
                }`}
              >
                {t.label}
              </button>
          ...
          <div className="grid grid-cols-1 items-center gap-10 rounded-[28px] border border-[#e9e3f5] bg-white p-8 shadow-[0_20px_50px_rgba(40,20,90,0.06)] lg:grid-cols-2 lg:p-12">
            <div className="flex flex-col gap-5">
              <h3 className="text-2xl font-extrabold leading-[1.15] tracking-[-0.02em] sm:text-3xl">
                {activeTab.heading}
              </h3>
              <p className="text-[17px] leading-relaxed text-[#4b4560]">{activeTab.description}</p>
              <div className="flex flex-col gap-2.5">
                {activeTab.bullets.map((b, i) => (
                  <div key={i} className="flex items-start gap-2.5 text-[15px] leading-relaxed text-[#4b4560]">
              ...
              <SecondaryButton href="#Pricing" className="w-fit">
            ...
            {/* Diagram */}
            <div className="overflow-hidden rounded-[20px] border border-[#eee9f7] bg-[#faf8fe]">
              {activeTab.table ? (
                <div className="overflow-x-auto">
                  <div className="flex items-center justify-between px-5 py-4">
                    <span className="whitespace-nowrap text-sm font-extrabold">Keyword tracker</span>
                    <span className="whitespace-nowrap rounded-full bg-[#fff1e0] px-3 py-1 text-xs font-bold text-[#9a3412]">
                      Amazon India
                    </span>
                  </div>
                  <div className="grid min-w-[480px] grid-cols-[2.2fr_1fr_1fr_1fr] gap-2 bg-[#f3effd] px-5 py-2.5 text-[11px] font-extrabold tracking-[0.05em] text-[#5f5875]">
                    <span>KEYWORD</span>
                    <span>SEARCHES</span>
                    <span>YOUR RANK</span>
                    <span>CHANGE</span>
                ...
                <div className="grid grid-cols-1 gap-3 p-5 sm:grid-cols-3">
                  {activeTab.stats?.map((s, i) => (
                    <div key={i} className="rounded-2xl border border-[#eee9f7] bg-white p-4">
                      <div className="text-xs font-semibold text-[#5f5875]">{s.label}</div>
                      <div className="text-xl font-extrabold">{s.value}</div>
                      <div className="text-xs font-bold text-[#15803d]">{s.change}</div>
                    </div>
                  ))}
                </div>
              )}
      ...
      <section className="bg-[#fdf2f8] py-16 lg:py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-12 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
            <div className="flex flex-col items-start gap-3 text-left">
              ...
              <p className="max-w-2xl text-lg leading-relaxed text-[#4b4560]">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
            {[
              ...
              <div
                key={i}
                className="flex h-full flex-col overflow-hidden rounded-[24px] border border-[#eee9f7] bg-white shadow-[0_12px_30px_rgba(40,20,90,0.05)]"
              >
                <div
                ...
                >
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="flex h-14 w-14 items-center justify-center rounded-full bg-white/90 shadow-lg">
                      <svg className="ml-1 h-5 w-5 fill-current text-violet-600" viewBox="0 0 24 24">
                ...
                <div className="flex flex-grow flex-col gap-3 p-6">
                  <h3
                    className="cursor-pointer text-lg font-extrabold leading-snug hover:text-violet-600"
                    onClick={() => setPlayingVideo(v.video)}
                  >
                    {v.title}
                  </h3>
                  <p className="flex-grow text-sm leading-relaxed text-[#5f5875]">{v.desc}</p>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              >
                ...
                <div className="flex items-start gap-2 text-sm leading-relaxed text-[#4b4560]">
                  <Check className="mt-0.5 h-4 w-4 flex-shrink-0 text-green-600" />
                  <span>{c.desc}</span>
                </div>
                <span className="mt-auto flex items-center gap-1.5 text-sm font-extrabold text-[#1a1033]">
      ...
      {/* Compare Section */}
      <section id="Compare" className="scroll-mt-20 bg-[#fdf2f8] py-16 lg:py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto mb-14 flex max-w-2xl flex-col items-center gap-4 text-center">
          ...
          <div className="mb-14 grid grid-cols-2 gap-4 sm:gap-6 md:grid-cols-4">
            {[
              { icon: Target, text: "Streamlined, simple UX", bg: "bg-[#e3edff]", color: "text-[#1e40af]" },
              { icon: Zap, text: "Superior AI insights", bg: "bg-violet-100", color: "text-violet-700" },
              { icon: DollarSign, text: "Exceptional value", bg: "bg-[#dcfce7]", color: "text-[#166534]" },
              { icon: Globe, text: "India first expertise", bg: "bg-[#fff1e0]", color: "text-[#9a3412]" },
            ].map((item, i) => (
              <div
                key={i}
                className="flex flex-col items-center gap-3 rounded-[20px] border border-[#eee9f7] bg-white p-6 text-center"
              >
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
            {[
              ...
              <div
                key={i}
                className={`flex flex-col gap-5 rounded-[24px] border-2 ${c.border} bg-white p-8`}
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-[#5f5875]">{c.vs}</p>
                  </div>
                </div>
                <ul className="flex flex-1 flex-col gap-3">
                  {c.points.map((p, j) => (
                    <li key={j} className="flex items-start gap-2.5 text-sm leading-relaxed text-[#4b4560]">
                      <Check className="mt-0.5 h-4 w-4 flex-shrink-0 text-green-600" />
                      <span>{p}</span>
                    </li>
                  ))}
      ...
      {/* Resources Section */}
      <section id="Resources" className="scroll-mt-20 bg-white py-16 lg:py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              >
                ...
                <h3 className="text-lg font-extrabold">{c.title}</h3>
                <p className="flex-grow text-sm leading-relaxed text-[#4b4560]">{c.desc}</p>
      ...
      {/* About Section */}
      <section id="About" className="scroll-mt-20 bg-[#f6f1ff] py-16 lg:py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto mb-14 flex max-w-2xl flex-col items-center gap-4 text-center">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            {[
              ...
              <div key={i} className="flex flex-col items-center gap-4 rounded-[24px] bg-white p-8 text-center">
                <div className={`flex h-16 w-16 items-center justify-center rounded-2xl ${c.bg}`}>
                  <c.icon className={`h-8 w-8 ${c.color}`} />
                </div>
                <h3 className="text-lg font-extrabold">{c.title}</h3>
                <p className="text-sm leading-relaxed text-[#4b4560]">{c.desc}</p>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="mx-auto grid max-w-4xl grid-cols-1 gap-5 sm:grid-cols-2">
            {[
              ...
              >
                ...
                <div className="text-sm font-semibold text-[#5f5875]">{stat.subtitle}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section id="Testimonials" className="scroll-mt-20 bg-[#fcfaff] py-16 lg:py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto mb-14 flex max-w-2xl flex-col items-center gap-4 text-center">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
            {testimonials.map((t, i) => (
              <div
                key={i}
                className="flex h-full flex-col justify-between rounded-[24px] border border-[#eee9f7] bg-white p-7 shadow-[0_10px_30px_rgba(40,20,90,0.04)]"
              >
                <div className="mb-6 flex items-start justify-between">
                  <span className={`flex h-11 w-11 items-center justify-center rounded-xl text-xl ${t.logoBg}`}>
                    {t.logo}
                  </span>
                  <span className="flex items-center gap-2 rounded-full bg-[#f3effd] px-3 py-1">
                    <span className="text-sm font-bold text-[#3b3552]">{t.rating}</span>
                    <Star className="h-3.5 w-3.5 fill-green-500 text-green-500" />
                  </span>
                </div>

                <p className="mb-6 flex-grow text-[15px] italic leading-relaxed text-[#4b4560]">
                  &ldquo;{t.text}&rdquo;
                </p>

                <div>
                  <h4 className="text-base font-extrabold">{t.author}</h4>
                  <p className="text-sm font-medium text-[#5f5875]">{t.handle}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      {/* Pricing Section */}
      <section id="Pricing" className="scroll-mt-20 bg-white py-16 lg:py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 items-start gap-5 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="flex flex-col gap-5 rounded-[24px] border border-[#eee9f7] p-8">
              <span className="flex h-11 w-11 items-center justify-center rounded-xl bg-[#e3edff]">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-[#4b4560]">Perfect for getting started</p>
              </div>
              <SecondaryButton onClick={handleGetStarted} className="w-full">
                Get started free
              </SecondaryButton>
              <ul className="flex flex-col gap-2.5 border-t border-[#f0ebf8] pt-5 text-sm text-[#4b4560]">
                {[
            ...
            <div className="relative flex flex-col gap-5 rounded-[24px] border-2 border-violet-600 p-8 shadow-[0_24px_60px_rgba(124,58,237,0.18)]">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-[#4b4560]">Ideal for growing businesses</p>
              </div>
            ...
            <div className="flex flex-col gap-5 rounded-[24px] border border-[#eee9f7] p-8">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-[#4b4560]">For serious professionals</p>
              </div>
              <button
            ...
            {/* Enterprise */}
            <div className="flex flex-col gap-5 rounded-[24px] border border-[#eee9f7] p-8">
              <span className="flex h-11 w-11 items-center justify-center rounded-xl bg-[#f3f0fa]">
                <Building2 className="h-5 w-5 text-[#3b3552]" />
              </span>
              <span className="text-lg font-extrabold">Enterprise</span>
              <div>
                <div className="text-3xl font-extrabold tracking-[-0.02em]">Custom</div>
                <p className="mt-1 text-sm text-[#4b4560]">Tailored for SMBs and agencies</p>
              </div>
              <SecondaryButton onClick={handleGetStarted} className="w-full">
                Contact sales
              </SecondaryButton>
      ...
      {/* FAQ Section */}
      <section className="bg-[#fcfaff] py-16 lg:py-20">
        <div className="mx-auto grid max-w-7xl grid-cols-1 gap-12 px-4 sm:px-6 lg:grid-cols-[0.8fr_1.2fr] lg:px-8">
          <div className="flex flex-col items-start gap-6 text-left">
            <div className="flex flex-col items-start gap-3">
              ...
              <p className="max-w-sm text-lg leading-relaxed text-[#4b4560]">
            ...
            {faqs.map((f, i) => (
              <details key={i} className="group border-b border-[#eee9f7] py-5" open={i === 0}>
                <summary className="flex cursor-pointer list-none items-center justify-between gap-4 text-lg font-extrabold [&::-webkit-details-marker]:hidden">
                  {f.q}
                  <span className="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full bg-[#f3effd] text-xl font-bold text-violet-600 transition-transform group-open:rotate-45">
                    +
                  </span>
                </summary>
                <p className="mt-3.5 pr-12 text-[15px] leading-relaxed text-[#4b4560]">{f.a}</p>
              </details>
            ))}
          </div>
        </div>
        ...
        <div className="relative mx-auto max-w-7xl overflow-hidden rounded-[32px] bg-gradient-to-br from-[#3b0f8a] via-[#1a1033] to-[#5b1265] px-8 py-16 sm:px-16">
          ...
          <div className="relative z-10 flex flex-col items-start gap-8 text-white lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="flex flex-shrink-0 flex-col gap-3">
              <Link
                href="/login"
                className="rounded-full bg-white px-9 py-4 text-center text-[17px] font-extrabold text-[#1a1033] shadow-2xl transition-transform hover:-translate-y-0.5"
              >
                Create free account
              </Link>
              <Link
                href="/contact"
                className="rounded-full border border-white/40 px-8 py-3.5 text-center text-[15px] font-bold text-white transition-colors hover:bg-white/5"
              >
                Book a demo
              </Link>
