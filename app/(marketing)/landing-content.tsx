          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-8 items-center">
            ...
            <div className="flex flex-col space-y-3 lg:space-y-4 text-left mt-2 lg:mt-0">
              ...
              <div className="flex items-center space-x-3 text-xs text-gray-500 font-medium">
                ...
                <span className="px-2 py-0.5 rounded bg-orange-50 text-orange-600 border border-orange-100 font-semibold">
                  Amazon India
                </span>
                <span className="px-2 py-0.5 rounded bg-blue-50 text-blue-600 border border-blue-100 font-semibold">
                  Flipkart
                </span>
              </div>
              ...
              <div className="text-gray-600 dark:text-gray-400 text-sm sm:text-base max-w-xl leading-relaxed">
                <p>
                  ...
                  shows you exactly which products make money, what competitors
                  are doing, and where you lose sales.
                </p>
              </div>
          ...
          <div className="flex flex-col md:flex-row md:items-end md:justify-between mb-12">
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-black text-gray-900 dark:text-white leading-tight mb-4 tracking-tight">
                Learn from India's{" "}
                <span className="bg-gradient-to-r from-purple-600 to-[#8B5CF6] bg-clip-text text-transparent">
                  Top Sellers
                </span>
              </h2>
              <p className="text-gray-600 dark:text-gray-400 text-lg max-w-xl font-medium">
                Free strategy walkthroughs on Amazon.in, Flipkart, PPC & festive
                prep — straight from real sellers.
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-3xl border border-gray-100 dark:border-gray-700/60 shadow-[0_10px_35px_rgba(0,0,0,0.03)] overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-1.5 flex flex-col h-full group">
              <div
                ...
                style={{
                  backgroundImage:
                    "url('/Insydz%20Feature%20-%20Opportunity%20Finder%20Cover%20Image.png')",
                }}
                onClick={() =>
                  setPlayingVideo(
              ...
              <div className="p-6 flex flex-col flex-grow">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400 leading-relaxed mb-6 font-medium flex-grow">
                  ...
                  Insydz Opportunity Finder. See competitor counts, revenue
                  potential, pricing gaps, demand signals, and AI-powered
            ...
            <div className="bg-white dark:bg-gray-800 rounded-3xl border border-gray-100 dark:border-gray-700/60 shadow-[0_10px_35px_rgba(0,0,0,0.03)] overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-1.5 flex flex-col h-full group">
              <div
                ...
                style={{
                  backgroundImage:
                    "url('/Insydz%20-%20Navigation%20Guide%20Cover%20Image.png')",
                }}
                onClick={() =>
                  setPlayingVideo(
            ...
            <div className="bg-white dark:bg-gray-800 rounded-3xl border border-gray-100 dark:border-gray-700/60 shadow-[0_10px_35px_rgba(0,0,0,0.03)] overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-1.5 flex flex-col h-full group">
              <div
                ...
                style={{
                  backgroundImage:
                    "url('/Insydz%E2%80%99s%20Market%20Visibility%20-%20Cover%20Image.png')",
                }}
                onClick={() =>
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <span className="text-sm text-gray-700 dark:text-gray-300">
                    Win Buy Box, optimize keywords & pricing with AI-powered
                    intelligence
                  </span>
                </li>
              </ul>
            ...
            >
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  <Check className="w-5 h-5 text-green-500 mr-3 flex-shrink-0 mt-0.5" />
                  <span className="text-sm text-gray-700 dark:text-gray-300">
                    Track competitors & reviews effortlessly never get
                    blindsided before Big Billion Days
                  </span>
                </li>
              </ul>
            </Link>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
            ...
            >
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-4 flex-grow">
                In-depth growth frameworks for festive season prep, Buy Box
                recovery, new product launches, and competitive repositioning
              </p>
