        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 sm:h-20">
            ...
            <div className="hidden lg:flex items-center space-x-1 xl:space-x-2" ref={dropdownRef}>
              ...
              <button onClick={() => router.push('/pricing')} onMouseEnter={() => setActiveDropdown(null)} className="px-2 xl:px-3 py-2 text-xs xl:text-sm text-gray-700 dark:text-gray-300 hover:text-pink-600 font-medium rounded-lg hover:bg-pink-50 dark:hover:bg-pink-900/20 transition-all">Pricing</button>
        ...
        {isMenuOpen && (
          <div className="lg:hidden bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800 max-h-[calc(100vh-4rem)] overflow-y-auto">
            <div className="px-3 sm:px-4 py-3 sm:py-4 space-y-1 sm:space-y-2">
              <button onClick={() => { router.push('/'); setIsMenuOpen(false); }} className="flex items-center gap-2 w-full px-3 sm:px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-pink-50 dark:hover:bg-pink-900/20 rounded-lg font-medium">
              ...
              <button onClick={() => router.push('/pricing')} className="block w-full text-left px-3 sm:px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-pink-50 dark:hover:bg-pink-900/20 rounded-lg font-medium">Pricing</button>
              {/* Free Tools */}
              <div>
              ...
              <Button onClick={() => { router.push('/login'); setIsMenuOpen(false); }} className="w-full mt-2 bg-gradient-to-r from-pink-500 to-rose-500 text-sm py-2.5">Login</Button>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {[
              ...
              <div key={i} onClick={() => feature.route && router.push(feature.route)} className="bg-gradient-to-br from-gray-50 to-white dark:from-gray-900 dark:to-gray-800 border-2 border-gray-200 dark:border-gray-700 rounded-xl p-5 sm:p-6 hover:border-pink-400 hover:shadow-lg transition-all cursor-pointer group">
      ...
      <section className="py-12 sm:py-16 md:py-20 px-4 bg-gradient-to-br from-pink-50 to-rose-50 dark:from-gray-900 dark:to-gray-800">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
            ...
            <Button onClick={() => router.push("/")} size="lg" variant="outline" className="w-full sm:w-auto border-2 border-pink-600 text-pink-700 dark:text-pink-500 hover:bg-pink-50 dark:hover:bg-pink-900/20 font-semibold px-8 sm:px-12 py-4 sm:py-6 text-sm sm:text-lg rounded-full">
