                ...
                <div className="space-y-1.5">
                  <div className="flex justify-between items-center">
                    ...
                    <button
                      ...
                      className="text-[11px] text-blue-600 dark:text-blue-400 hover:underline bg-transparent border-none p-0 cursor-pointer"
                    >
                  ...
                  <div className="relative">
                    ...
                    <button
                      ...
                      className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 dark:text-slate-500 hover:text-gray-600 dark:hover:text-slate-300 bg-transparent border-none p-0 cursor-pointer flex items-center justify-center"
                    >
                      {showPassword ? (
                  ...
                  {formData.password && (
                    <div className="space-y-1 mt-1.5">
                      <div className="flex justify-between items-center text-[10px]">
                        <span className="text-gray-400 dark:text-slate-500">Password strength:</span>
                        <span className={cn("font-semibold", strength.text)}>{strength.label}</span>
                      </div>
                      <div className="grid grid-cols-4 gap-1.5 h-1">
                        <div className={cn("rounded-full transition-all duration-300", strength.score >= 1 ? strength.color : "bg-gray-200 dark:bg-slate-700")} />
                        <div className={cn("rounded-full transition-all duration-300", strength.score >= 2 ? strength.color : "bg-gray-200 dark:bg-slate-700")} />
                        <div className={cn("rounded-full transition-all duration-300", strength.score >= 3 ? strength.color : "bg-gray-200 dark:bg-slate-700")} />
                        <div className={cn("rounded-full transition-all duration-300", strength.score >= 4 ? strength.color : "bg-gray-200 dark:bg-slate-700")} />
                      </div>
                    </div>
                  )}
