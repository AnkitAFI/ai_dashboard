...
//       // If we don't have stats yet or if the backend says it's still syncing, poll
//       interval = setInterval(() => {
//         if (!stats || stats.status === "SYNCING" || (stats.metrics && stats.metrics.total_products === 0)) {
//            fetchStats();
//         }
...
//   const hasNoData = stats.metrics && stats.metrics.total_products === 0;
...
//           <p className="text-slate-500 mt-1">Real-time performance metrics for Merchant ID: <span className="font-mono text-blue-600 bg-blue-50 px-2 py-0.5 rounded">{user?.seller_id}</span></p>
//         </div>
//         <button 
...
//           description="Percentage of Prime fulfilled"
//         />
//         <MetricCard 
//           title="Total Reviews" 
...
//         <MetricCard 
//           title="Average BSR" 
//           value={`#${metrics.avg_bsr.toLocaleString()}`} 
//           icon={<BarChart3 className="w-6 h-6 text-indigo-600" />} 
//           description="Best Seller Rank across categories"
//           trend={{ value: "5 spots down", positive: false }}
//         />
//         <MetricCard 
//           title="Best Sellers" 
...
//         <MetricCard 
//           title="FBA Rate" 
//           value={`${metrics.fba_rate_pct}%`} 
//           icon={<ShieldCheck className="w-6 h-6 text-teal-600" />} 
//           description="Fulfillment by Amazon ratio"
//         />
//       </div>
...
//               Feedback Sentiment
//             </CardTitle>
//             <CardDescription>AI-powered sentiment analysis of customer reviews</CardDescription>
//           </CardHeader>
//           <CardContent className="h-[350px]">
//             <ResponsiveContainer width="100%" height="100%">
...
//                     <Cell 
//                       key={`cell-${index}`} 
//                       fill={entry.name === "Positive" ? "#10b981" : entry.name === "Neutral" ? "#f59e0b" : "#ef4444"} 
//                     />
//                   ))}
//                 </Bar>
//               </BarChart>
...
//               BSR Visibility Trend
//             </CardTitle>
//             <CardDescription>Historical Best Seller Rank (lower is better)</CardDescription>
//           </CardHeader>
//           <CardContent className="h-[350px]">
//             <ResponsiveContainer width="100%" height="100%">
//               <LineChart data={charts.bsr_trend}>
//                 <CartesianGrid strokeDasharray="3 3" vertical={false} stroke="#f1f5f9" />
//                 <XAxis dataKey="name" axisLine={false} tickLine={false} tick={{fill: "#94a3b8", fontSize: 12}} dy={10} />
//                 <YAxis reversed axisLine={false} tickLine={false} tick={{fill: "#94a3b8", fontSize: 12}} />
//                 <Tooltip 
//                   contentStyle={{ borderRadius: "12px", border: "none", boxShadow: "0 10px 15px -3px rgb(0 0 0 / 0.1)" }}
//                 />
//                 <Line 
