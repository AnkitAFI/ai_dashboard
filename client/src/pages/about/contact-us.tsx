...
export default function ContactUsPage() {
  ...
  return (
    <div className="min-h-screen bg-white font-sans">
      <Helmet>
        <link rel="canonical" href="https://insydz.com/about/contact-us" />
        <title>Get in Touch with INSYDZ</title>
        <meta name="description" content="Questions about the product, partnerships, or support? We're here to help." />
      </Helmet>
      {/* ── NAVIGATION ── */}
