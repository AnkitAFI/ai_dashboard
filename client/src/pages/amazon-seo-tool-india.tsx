...
export default function AmazonSeoToolIndia() {
  ...
  useEffect(() => {
    SCHEMAS.forEach((schema, i) => {
      const id = `insydz-blog2-schema-${i}`;
    ...
    return () => {
      SCHEMAS.forEach((_, i) => {
        const el = document.getElementById(`insydz-blog2-schema-${i}`);
        if (el) el.remove();
      });
    };
  }, []);
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950 transition-colors" style={{ overflowX: "hidden" }}>
      <Helmet>
        ...
        <meta name="description" content="Discover how an Amazon SEO tool built for India helps sellers rank higher, find buying keywords, and grow sales on Amazon.in. Plans from ₹1,999/month. Try free." />
        ...
        <main style={{ minWidth: 0 }}>
          ...
          <article className="article-body">
            ...
            <div className="callout indigo">
              ...
              <div className="callout-text">
                <InLink to="/features">Amazon SEO tools for India help sellers identify high-converting keywords, track daily ranking positions, and optimise product listings to rank higher on Amazon.in's A9 algorithm</InLink>. For Indian sellers, tools built specifically for the Indian market surface Hinglish search patterns and{" "}
            ...
            <div className="inline-cta">
              ...
              <button onClick={() => setLocation("/login")} className="bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 text-white font-bold text-sm px-5 sm:px-6 py-3 rounded-xl transition-all whitespace-nowrap w-full sm:w-auto">
                Start Free at insydz.com →
              </button>
            </div>
