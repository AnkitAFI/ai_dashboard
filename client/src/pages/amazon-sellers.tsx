...
export default function AmazonSellersPage() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950">
      <Helmet>
        <link rel="canonical" href="https://insydz.com/solutions/amazon-sellers" />
        <title>Amazon Seller Analytics & Price Tracker Tool | Insydz</title>
        <meta name="description" content="All-in-one Amazon seller analytics tool. Track competitor prices, research products, and win the Buy Box. Built for Indian Amazon & Flipkart sellers. Try free." />
         <script
    type="application/ld+json"
    dangerouslySetInnerHTML={{ __html: JSON.stringify(schemaBreadcrumbAmazonSellers) }}
  />

  {/* FAQ */}
  <script
    type="application/ld+json"
    dangerouslySetInnerHTML={{ __html: JSON.stringify(schemaFAQAmazonSellers) }}
  />
      </Helmet>
      {/* ── NAVIGATION ────────────────────────────────────────────────────────── */}
