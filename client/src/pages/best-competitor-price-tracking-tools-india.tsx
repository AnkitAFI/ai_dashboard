          ...
          <article className="article-body">
            ...
            <div className="mistake-list">
              {[
                ...
                { n:5, t:"Not Connecting Price Tracking to Stock Monitoring", d:<>Price and stock are inseparable signals. When a competitor drops their price, it might mean they're overstocked — and will be out of stock in 3 weeks. If you know they're about to go OOS, you don't need to match their discount. <a href="/resources/expert-blog/amazon-competitor-price-tracking-tool-india" style={{color:"#dc2626", textDecoration:"underline"}}>Automated price tracking connected to stock monitoring</a> lets you hold your price and prepare for the demand surge.</>},
              ].map(m => (
