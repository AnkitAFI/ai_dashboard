...
export default function HowToRankPage1AmazonIndia() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950 transition-colors">
      <Helmet>
        <link rel="canonical" href="https://insydz.com/resources/expert-blog/how-to-rank-page-1-amazon-india" />
        <title>How to Rank on Page 1 of Amazon India: The Complete Guide for Sellers (2026)</title>
        <meta name="description" content="Learn exactly how to rank on page 1 of Amazon India using the A9 algorithm, keyword optimization & competitor intelligence. An actionable 4-phase guide for Indian sellers." />
      </Helmet>
      <style>{`
