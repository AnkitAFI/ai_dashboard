...
export default function InsydzVsHelium10India() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950 transition-colors">
      <Helmet>
        <link rel="canonical" href="https://insydz.com/resources/expert-blog/insydz-vs-helium-10-india" />
        <title>Insydz vs Helium 10 for Indian Sellers: 2026 Comparison | Insydz</title>
        <meta name="description" content="Insydz vs Helium 10: honest comparison for Indian Amazon & Flipkart sellers. Covers Hinglish data, Flipkart support, WhatsApp alerts, and rupee pricing." />
      </Helmet>
        ...
        {isMenuOpen && (
          <div className="lg:hidden bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800 max-h-[calc(100vh-5rem)] overflow-y-auto">
            <div className="px-4 py-4 space-y-2">
              ...
              <button onClick={() => { setLocation("/pricing"); setIsMenuOpen(false); }} className="block w-full text-left px-4 py-2 text-gray-700 dark:text-gray-300 hover:bg-purple-50 rounded-lg font-medium">Pricing</button>
