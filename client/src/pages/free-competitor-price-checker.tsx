...
export default function FreeCompetitorPriceCheckerPage() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950">
      ...
      {/* ── SEO HEAD ── */}
      <Helmet>
        <title>Free Amazon Competitor Price Checker for India — Insydz | Track Competitor Prices &amp; Win the Buy Box</title>
        <meta name="description" content="Free Amazon competitor price checker for Indian sellers. Instantly see how competitors are pricing in your category — lowest, highest, average, seller count. Win the Buy Box and protect your margins. No credit card required." />
        <meta name="keywords" content="free amazon competitor price checker, free product price checker, amazon price comparison tool, competitor price tracking tool, amazon competitor price analyzer, amazon competitor price analysis tool, free competitor price checker for amazon india" />
        ...
        <script type="application/ld+json">{JSON.stringify({
          ...
          "name": "Insydz Free Amazon Competitor Price Checker",
          "applicationCategory": "BusinessApplication",
          "operatingSystem": "Web",
          "url": "https://insydz.com/free-tools/free-competitor-price-checker",
          "description": "Free Amazon competitor price checker for Indian sellers. Instantly see how competitors are pricing in your category — lowest, highest, average, seller count. Win the Buy Box and protect your margins. No credit card required.",
          "featureList": [
            "Competitor price range — lowest, highest, average in INR",
            "Active seller count on the ASIN",
            "Price distribution by price band",
            "Buy Box win probability at current price",
            "30-day price trend direction"
          ],
          "offers": {
            "@type": "Offer",
            "price": "0",
        ...
        <script type="application/ld+json">{JSON.stringify({
          "@context": "https://schema.org",
          "@type": "HowTo",
          "name": "How to Check Competitor Prices on Amazon India for Free",
          "description": "Check competitor pricing for any Amazon India product ASIN in 3 steps.",
          "totalTime": "PT2M",
          "step": [
            {
              "@type": "HowToStep",
              "position": 1,
              "name": "Enter ASIN or Product Link",
              "text": "Paste any Amazon India product URL or ASIN — yours or a competitor's listing."
            },
            {
              "@type": "HowToStep",
              "position": 2,
              "name": "Insydz Scans the Market",
              "text": "We pull current pricing from all active sellers competing on that ASIN in real time — not stored estimates."
            },
            {
              "@type": "HowToStep",
              "position": 3,
              "name": "Get Instant Price Intelligence",
              "text": "See the full price landscape — lowest, highest, average, seller count, Buy Box zone, and 30-day trend — immediately."
            }
          ]
        })}</script>
        ...
        <script type="application/ld+json">{JSON.stringify({
          ...
          "itemListElement": [
            ...
            },
            {
              ...
              "item": "https://insydz.com/free-tools/free-competitor-price-checker"
            }
          ]
        })}</script>
      </Helmet>
      ...
      <section className="py-24 px-4 bg-gradient-to-br from-teal-500 to-cyan-500">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <button onClick={() => { if (!isLoggedIn) { setLocation('/login'); } else { window.scrollTo({ top: 0, behavior: 'smooth' }); } }} className="bg-white text-teal-600 font-black px-10 sm:px-14 py-5 rounded-full shadow-2xl hover:scale-105 transition-all text-lg inline-flex items-center gap-3">
