...
const UseCasesPage = () => {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950 overflow-x-hidden">
      <Helmet>
        <link rel="canonical" href="https://insydz.com/use-cases" />
        <title>Ecommerce Seller Analytics Software — What Can Insydz Do?</title>
        <meta name="description" content="See how sellers use Insydz to track competitor prices, find profitable products, improve listings, and avoid stockouts on Amazon & Flipkart. Explore use cases." />
