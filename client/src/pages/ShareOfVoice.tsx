        ...
        <main className="px-4 sm:px-6 flex-1 overflow-y-auto pb-10 space-y-6">
          ...
          {!loading && activeTab === "category" && sovData && (
            <>
                  ...
                  <Card key={i} className={`relative bg-gradient-to-br ${c.grad} text-white border-0 rounded-3xl shadow-xl overflow-hidden group hover:scale-[1.02] transition-transform`}>
                    <CardContent className="p-5 relative">
                      <div className="flex items-start justify-between">
                        ...
                        <div className="w-12 h-12 bg-white/20 rounded-xl flex items-center justify-center shrink-0 ml-2">{c.icon}</div>
                      </div>
                    </CardContent>
                  </Card>
                ))}
              ...
              {/* ── Market Decision + Confidence (from market-health) ── */}
              {marketHealth && (
                <>
                  {/* Decision Banner */}
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                {/* Horizontal Bar — Top Brands by Reviews */}
                <Card className="bg-white/80 backdrop-blur-md border border-slate-200 rounded-2xl shadow-lg">
                  <CardHeader className="pb-2">
                    <CardTitle className="flex items-center gap-2 text-base">
              ...
              <Card id="brands-table" className="bg-white/80 backdrop-blur-md border border-slate-200 rounded-2xl shadow-lg overflow-hidden">
              ...
              {yourBrand && progressData && (
                <>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <Card className={`border-l-4 ${progressData.is_on_track ? "border-green-500" : "border-red-500"} bg-white/80 rounded-2xl shadow-lg`}>
                    ...
                    <Card className="border-l-4 border-blue-500 bg-white/80 rounded-2xl shadow-lg">
                    ...
                    <Card className="border-l-4 border-purple-500 bg-white/80 rounded-2xl shadow-lg">
                      <CardContent className="p-5">
                ...
                <>
                  ...
                  {aiInsights && !loadingInsights && (
                    <>
                      ...
                      {/* Market Health from AI endpoint */}
                      {aiInsights.market_decision && (
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          <Card className="bg-white/80 rounded-2xl shadow-lg border border-slate-200">
                ...
                <div id="competitor-section">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {paginatedCompetitors.map((c, idx) => {
                      ...
                      return (
                        <Card key={idx} className="bg-white/80 border border-slate-200 rounded-2xl shadow-lg hover:shadow-xl hover:scale-[1.01] transition-all overflow-hidden">
                          <CardContent className="p-5">
            ...
            <>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {[
                  ...
                  <Card key={x.l} className="bg-white/80 border border-slate-200 rounded-2xl shadow-lg">
                    <CardContent className="p-5 flex items-center justify-between">
                      <div>
