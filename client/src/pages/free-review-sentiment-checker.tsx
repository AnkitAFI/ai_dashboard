...
export default function FreeReviewSentimentCheckerPage() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950">
      ...
      {/* ── SEO HEAD ── */}
      <Helmet>
        <title>Free Amazon Review Sentiment Checker for India — Insydz | Analyze Buyer Reviews Instantly</title>
        <meta name="description" content="Instantly understand what buyers love, hate, and complain about — for any Amazon India product. Improve your listing, fix product gaps, and outperform competitors. Reads Hindi + English reviews. Free forever." />
        <meta name="keywords" content="free review sentiment checker, customer review sentiment analysis, amazon review analysis tool india, amazon review analyzer, AI review sentiment analyzer, free AI sentiment analysis tool, amazon review intelligence" />
        ...
        <script type="application/ld+json">{JSON.stringify({
          ...
          "name": "Insydz Free Review Sentiment Checker",
          "applicationCategory": "BusinessApplication",
          "operatingSystem": "Web",
          "url": "https://insydz.com/free-tools/free-review-sentiment-checker",
          "description": "Instantly understand what buyers love, hate, and complain about — for any Amazon India product. Improve your listing, fix product gaps, and outperform competitors. Reads Hindi + English reviews. Free forever.",
          "featureList": [
            "Sentiment score (0-100)",
            "Top 4 complaint themes",
            "Top 4 praise themes",
            "Star rating breakdown",
            "Primary improvement opportunity",
            "Hindi + English review processing"
          ],
          "offers": {
            "@type": "Offer",
            "price": "0",
        ...
        <script type="application/ld+json">{JSON.stringify({
          "@context": "https://schema.org",
          "@type": "HowTo",
          "name": "How to Analyse Amazon India Review Sentiment for Free",
          "description": "Check the review sentiment for any Amazon India or Flipkart product in 3 steps.",
          "totalTime": "PT2M",
          "step": [
            {
              "@type": "HowToStep",
              "position": 1,
              "name": "Enter the Product ASIN",
              "text": "Paste any Amazon India or Flipkart product URL or ASIN."
            },
            {
              "@type": "HowToStep",
              "position": 2,
              "name": "Insydz Analyses Reviews",
              "text": "We process reviews in Hindi and English, extracting complaint themes, praise patterns, and sentiment signals from all available reviews."
            },
            {
              "@type": "HowToStep",
              "position": 3,
              "name": "Get Your Sentiment Report",
              "text": "Receive sentiment score, top 4 complaints, top 4 praise themes, star breakdown, and primary improvement opportunity — instantly."
            }
          ]
        })}</script>
        ...
        <script type="application/ld+json">{JSON.stringify({
          ...
          "itemListElement": [
            ...
            },
            {
              ...
              "item": "https://insydz.com/free-tools/free-review-sentiment-checker"
            }
          ]
        })}</script>
      </Helmet>
      ...
      <section className="py-24 px-4 bg-gradient-to-br from-purple-500 to-pink-500">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <button onClick={() => { if (!isLoggedIn) { setLocation('/login'); } else { window.scrollTo({ top: 0, behavior: 'smooth' }); } }} className="bg-white text-purple-600 font-black px-10 sm:px-14 py-5 rounded-full shadow-2xl hover:scale-105 transition-all text-lg inline-flex items-center gap-3">
