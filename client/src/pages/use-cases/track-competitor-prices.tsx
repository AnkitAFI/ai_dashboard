...
export default function TrackCompetitorPricesPage() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950 overflow-x-hidden">
      <Helmet>
        <link rel="canonical" href="https://insydz.com/use-cases/track-competitor-prices" />
        <title>Competitor Price Tracking Tool for Amazon & Flipkart India | Insydz</title>
        <meta name="description" content="Track competitor prices in real time on Amazon & Flipkart. Get Buy Box alerts, historical price data, and a live price tracking dashboard fully automated." />
              ...
              <div key={i} className="bg-white dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-700 rounded-2xl p-6 sm:p-8 hover:border-orange-400 hover:shadow-xl transition-all">
                <div className="flex items-start gap-3 sm:gap-4">
                  ...
                  <div>
                    ...
                    <button onClick={() => setLocation(item.link)} className="text-xs font-semibold text-orange-600 hover:text-orange-700 underline">See {item.linkLabel} →</button>
                  </div>
                </div>
              </div>
            ))}
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {[
              ...
              <div key={i} onClick={() => setLocation(uc.route)} className="bg-white dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-700 rounded-xl p-4 sm:p-6 hover:border-orange-400 hover:shadow-lg transition-all cursor-pointer group">
