...
export default function FreeKeywordRankCheckerPage() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950">
      ...
      {/* ── SEO HEAD ── */}
      <Helmet>
        <title>Free Amazon Keyword Rank Checker for India — Insydz | Track Keyword Rankings &amp; Improve Visibility</title>
        <meta name="description" content="Instantly check where your product ranks for any keyword on Amazon India — so you can optimize your listing, close visibility gaps, and outrank competitors on the search results page. Free forever." />
        <meta name="keywords" content="free amazon keyword rank checker india, amazon keyword rank checker tool, free keyword rank checker, amazon keyword tracker, free amazon keyword tool, amazon keyword tool, keyword research tool for amazon, amazon keyword indexing checker" />
