...
export default function AnalyzeCustomerReviewsPage() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950 overflow-x-hidden">
      <Helmet>
        <link rel="canonical" href="https://insydz.com/use-cases/analyze-customer-reviews" />
        <title>Analyse Customer Reviews with AI Sentiment Analysis | Insydz</title>
        <meta name="description" content="Analyse thousands of Amazon & Flipkart reviews in minutes. Insydz AI sentiment analysis spots patterns and turns customer feedback into a competitive edge." />
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6 lg:gap-8">
            {[
              ...
              <div key={i} className="bg-gradient-to-br from-gray-50 to-white dark:from-gray-900 dark:to-gray-800 border-2 border-gray-200 dark:border-gray-700 rounded-2xl p-5 sm:p-6 hover:border-purple-400 hover:shadow-xl transition-all group">
                ...
                {feature.link && (
                  <button onClick={() => setLocation(feature.link!.href)} className="mt-2 sm:mt-3 text-purple-600 dark:text-purple-400 text-xs sm:text-sm font-semibold hover:underline">{feature.link.text}</button>
                )}
              </div>
            ))}
          </div>
